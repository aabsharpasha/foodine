...
(function(b) {
    ...
    b.extend(b.jgrid, {version: "4.5.3", htmlDecode: function(b) {
            ...
            if (g && null != g)
                if (!isNaN(g - 0) && "u" === ("" + d).toLowerCase())
                    h = new Date(1E3 * parseFloat(g));
                else if (g.constructor === Date)
                    h = g;
                else if (null !== i)
                    h = new Date(parseInt(i[1], 10)), i[3] &&
                    ...
                    for (k = d.length; j < k; j++)
                        "M" === d[j] && (i = b.inArray(g[j], e.monthNames), -1 !== i && 12 > i && (g[j] = i + 1, f.m = g[j])), "F" === d[j] && (i = b.inArray(g[j], e.monthNames, 12), -1 !== i && 11 < i && (g[j] = i + 1 - 12, f.m = g[j])), "a" === d[j] && (i = b.inArray(g[j], e.AmPm), -1 !== i && 2 > i && g[j] === e.AmPm[i] &&
                    ...
                    grouping: !1, groupingView: {groupField: [], groupOrder: [], groupText: [], groupColumnShow: [], groupSummary: [], showSummaryOnHide: !1, sortitems: [], sortnames: [], summary: [], summaryval: [], plusicon: "ui-icon-circlesmall-plus", minusicon: "ui-icon-circlesmall-minus", displayField: []}, ignoreCase: !1, cmTemplate: {}, idPrefix: "", multiSort: !1}, b.jgrid.defaults, d || {}), a = this, c = {headers: [], cols: [], footers: [], dragStart: function(c, d, f) {
                        ...
                        if (a) {
                            ...
                            if (g) {
                                ...
                                g *= h;
                                var B, F, A;
                                if (k < a && 0 >= j && (void 0 === e.lastpage || parseInt((k + f + g - 1) / g, 10) <= e.lastpage))
                                    F = parseInt((a - k + g - 1) / g, 10), 0 <= k || 2 > F || !0 === e.scroll ? (B = Math.round((k + f) / g) + 1, j = -1) : j = 1;
                                0 < j && (B = parseInt(f / g, 10) + 1, F = parseInt((f + a) / g, 10) + 2 - B, A = !0);
                                if (F && (!e.lastpage || !(B > e.lastpage || 1 === e.lastpage || B === e.page &&
                                        B === e.lastpage)))
                                    c.hDiv.loading ? c.timer = setTimeout(c.populateVisible, e.scrollTimeout) : (e.page = B, A && (c.selectionPreserver(d[0]), c.emptyRows.call(d[0], !1, !1)), c.populate(F))
                            }
                        }
                ...
                if ("TABLE" !== this.tagName.toUpperCase())
                    ...
                    if (0 === this.p.colNames.length)
                        for (f = 0; f < this.p.colModel.length; f++)
                            this.p.colNames[f] = this.p.colModel[f].label || this.p.colModel[f].name;
                    if (this.p.colNames.length !== this.p.colModel.length)
                        ...
                        var n = function(a, b) {
                            ...
                            if (e === 0)
                                B = B + ("width: " + c.headers[d].width + "px;");
                            ...
                            for (f = 0; f < a.p.colModel.length; f++) {
                                ...
                                if (c.name !== "cb" && c.name !== "subgrid" && c.name !== "rn") {
                                    ...
                                    if (a.p.keyIndex !== false && c.key === true)
                                        a.p.keyName = d[e];
                                    e++
                                }
                            }
                            ...
                            if (b.isXMLDoc(c)) {
                                ...
                                if (a.p.gridview === true) {
                                    ...
                                    if (a.p.grouping) {
                                        ...
                                        a.p.treeGrid === true && t > 0 ? b(a.rows[t]).after(p.join("")) : b("tbody:first",
                                                d).append(p.join(""))
                                }
                                if (a.p.subGrid === true)
                                    try {
                                ...
                                if (j)
                                    for (; m < c && x[m]; ) {
                                        ...
                                        if (g) {
                                            ...
                                            for (l = 0; l < w.length; l++)
                                                y[a.p.colModel[l + q + v + o].name] = b.jgrid.getAccessor(g, w[l]);
                                            y._id_ = b.jgrid.stripPref(a.p.idPrefix, p);
                                            a.p.data.push(y);
                                            a.p._index[y._id_] =
                                                    a.p.data.length - 1;
                            ...
                            if (b.isArray(a.p.data)) {
                                ...
                                if (a.p.treeGrid)
                                    ...
                                    if (a.p.grouping)
                                        for (n = 0; n < t; n++)
                                            q.orderBy(i[n], l.groupOrder[n], h[n].stype, h[n].srcfmt);
                            ...
                            if (!a.grid.hDiv.loading) {
                                ...
                                if (a.p.page <= 0)
                                    a.p.page = Math.min(1, a.p.lastpage);
                                if (f.search !== null)
                                ...
                                if (!(e === false || e === "stop"))
                                    if (b.isFunction(a.p.datatype))
                                        a.p.datatype.call(a, a.p.postData, "load_" + a.p.id, o, c, j);
                                    else {
                            ...
                            if (g[c].lso)
                                if (g[c].lso ===
                                    ...
                                    if (g[c].lso === "asc-desc" || g[c].lso === "desc-asc")
                                        g[c].lso = ""
                                }
                            else
                                g[c].lso = j = g[c].firstsortorder || "asc";
                            if (j) {
                                b("span.s-ico", i).show();
                            ...
                            if (a.p.colModel[d].sortable && !(a.p.savedRow.length > 0)) {
                                ...
                                if (a.p.multiSort)
                                    ...
                                    if (f) {
                                        if (a.p.lastsort === d && a.p.sortorder === f && !e)
                                            return;
                                        a.p.sortorder = f
                                    }
                                    e =
                                ...
                                if (b(a).triggerHandler("jqGridSortCol", [a.p.sortname, d, a.p.sortorder]) === "stop")
                                    a.p.lastsort = d;
                                else if (b.isFunction(a.p.onSortCol) && a.p.onSortCol.call(a, a.p.sortname, d, a.p.sortorder) === "stop")
                                    a.p.lastsort = d;
                                else {
                                    if (a.p.datatype === "local")
                        ...
                        a.p.keyName = !1;
                        for (f = 0; f < a.p.colModel.length; f++)
                            a.p.colModel[f] = b.extend(!0, {}, a.p.cmTemplate, a.p.colModel[f].template || {}, a.p.colModel[f]), !1 === a.p.keyIndex && !0 === a.p.colModel[f].key && (a.p.keyIndex = f);
                        ...
                        if (a.p.multiSort) {
                            ...
                            for (f = 0; f < da.length; f++)
                                D = b.trim(da[f]).split(" "), da[f] = b.trim(D[0]), qa[f] = D[1] ? b.trim(D[1]) : a.p.sortorder || "asc"
                        }
                        for (f = 0; f < this.p.colNames.length; f++)
                            D = a.p.headertitles ? ' title="' + b.jgrid.stripHtml(a.p.colNames[f]) + '"' : "", x += "<th id='" + a.p.id + "_" + a.p.colModel[f].name + "' role='columnheader' class='ui-state-default ui-th-column ui-th-" +
                        ...
                        b("th", j).each(function(d) {
                            ...
                            if (typeof ga !== "boolean")
                                ga = a.p.colModel[d].sortable = true;
                        ...
                        b(a).before(c.hDiv).click(function(c) {
                            ...
                            if (b(o).length ===
                                    0 || o[0].className.indexOf("ui-state-disabled") > -1 || (b(w, a).closest("table.ui-jqgrid-btable").attr("id") || "").replace("_frozen", "") !== a.id)
                                return this;
                        ...
                        a.updatepager = function(c, d) {
                            ...
                            if (m = m + (a.p.toppager ? m ? "," + a.p.toppager : a.p.toppager : "")) {
                                ...
                                if (a.p.viewrecords)
                                    if (a.p.reccount === 0)
                                        b(".ui-paging-info", m).html(a.p.emptyrecords);
                                    else {
                                        h = g + 1;
                                        j = a.p.records;
                                        if (b.fmatter) {
    ...
    b.jgrid.extend({getGridParam: function(b) {
            ...
            this.each(function() {
                if ((c =
                    ...
                    for (; g < c; )
                        b(this.rows[g]).hasClass("jqgrow") && (d[e] = this.rows[g].id, e++), g++
            });
            return d
            ...
            return this.each(function() {
                ...
                if (void 0 !== d) {
                    ...
                    if (g.p.multiselect) {
                        ...
                        if (e)
                            b("#jqg_" + b.jgrid.jqID(g.p.id) + "_" + b.jgrid.jqID(c), "#" + b.jgrid.jqID(e))[g.p.useProp ? "prop" : "attr"]("checked", !1);
                        g.setHeadCheckBox(!1)
                    }
                    c = null
                } else
                    g.p.multiselect ? (b(g.p.selarrrow).each(function(a, c) {
            ...
            this.each(function() {
                ...
                for (; i < a; )
                    e && (j = f.rows[i]), b(j).hasClass("jqgrow") && (b('td[role="gridcell"]',
                            j).each(function(a) {
                        h = f.p.colModel[a].name;
                        if ("cb" !== h && "subgrid" !== h && "rn" !== h)
                            if (!0 === f.p.treeGrid && h === f.p.ExpandColumn)
                                g[h] = b.jgrid.htmlDecode(b("span:first", this).html());
                            else
                                try {
                ...
                if (g)
                    try {
                        if (b(this.p.colModel).each(function(a) {
                            ...
                            if (f.p.treeGrid)
                                for (r in f.p.treeReader)
                                    f.p.treeReader.hasOwnProperty(r) && delete m[f.p.treeReader[r]];
        ...
        addRowData: function(d, g, c, e) {
            ...
            g && (b.isArray(g) ? (u = !0, c = "last", E = d) : (g = [g], u = !1), this.each(function() {
                ...
                for (var P = 0, Z = "", H = {}, U = b.isFunction(this.p.afterInsertRow) ? true :
                    ...
                    if (this.rows.length === 0)
                        b("table:first", this.grid.bDiv).append(f.join(""));
                    else
                        switch (c) {
                            case "last":
            ...
            this.each(function() {
                var j = this, k;
                if (!j.grid || !j.p.footerrow || "set" === d && e(g))
                    return!1;
                i = !0;
                ...
                b(c).keydown(function(d) {
                    ...
                    if (a)
                        if (h = c.p._index[b.jgrid.stripPref(c.p.idPrefix, a.id)], 37 === d.keyCode || 38 === d.keyCode || 39 === d.keyCode || 40 === d.keyCode) {
                            ...
                            13 === d.keyCode ? (b(c).triggerHandler("jqGridKeyEnter", [c.p.selrow]), b.isFunction(g.onEnter) && g.onEnter.call(c, c.p.selrow)) : 32 === d.keyCode && (b(c).triggerHandler("jqGridKeySpace", [c.p.selrow]), b.isFunction(g.onSpace) && g.onSpace.call(c, c.p.selrow))
                })
            })
        }, unbindKeys: function() {
            return this.each(function() {
    ...
    a.jgrid.extend({getColProp: function(a) {
                ...
                if (!this.ftoolbar) {
                    var e = function() {
                        ...
                        a.each(c.p.colModel, function() {
                            ...
                            if ((f = "custom" === this.stype && a.isFunction(this.searchoptions.custom_value) && 0 < j.length && "SPAN" === j[0].nodeName.toUpperCase() ? this.searchoptions.custom_value.call(c, j.children(".customelement:first"), "get") : j.val()) || "nu" === m || "nn" === m)
                                e[o] = f, i[o] = m, g++;
                            else
                                try {
                        ...
                        for (i = c.p.colModel.length; d < i && c.p.colModel[d].name !== j; )
                            d++;
                        d = c.p.colModel[d];
                        ...
                        for (d = 0; d < j.sopt.length; d++)
                            m = a.inArray(j.sopt[d], h), -1 !== m && (i = f === b.odata[m].oper ? "ui-state-highlight" : "", g += '<li class="ui-menu-item ' + i +
                    ...
                    a.each(c.p.colModel, function(k) {
                        ...
                        if (this.search) {
                            ...
                            switch (this.stype) {
                                case "select":
                                    if (d = this.surl || f.dataUrl)
                                        a(j).append(l), a.ajax(a.extend({url: d,
                                            dataType: "html", success: function(d) {
                                                if (f.buildSelect !== void 0)
                                                    (d = f.buildSelect(d)) && a("td:eq(1)", l).append(d);
                                                else
                                                    a("td:eq(1)", l).append(d);
                                        ...
                                        if (n) {
                                            ...
                                            if ("string" === typeof n) {
                                                ...
                                                for (s = 0; s < d.length; s++)
                                                    n = d[s].split(r), q = document.createElement("option"), q.value = n[0], q.innerHTML = n[1], k.appendChild(q)
                                            } else if ("object" === typeof n)
                                                for (s in n)
                                                    n.hasOwnProperty(s) && (q = document.createElement("option"), q.value = s, q.innerHTML = n[s], k.appendChild(q));
                                ...
                                case "custom":
                                    ...
                                    try {
                                        if (a.isFunction(f.custom_element)) {
                                            ...
                                            if (v)
                                                v = a(v).addClass("customelement"), a(j).find(">span").append(v);
                                            else
                                                throw"e2";
                                        } else
                                            throw"e1";
        ...
        destroyFilterToolbar: function() {
            ...
            return this.each(function() {
                ...
                for (c = 0; c < t; c++)
                    if (k = m[c].el, g = a(k), e = o[c], h = {height: "0px", width: m[c].width + "px", display: e.hidden ? "none" : ""}, a("<th>", {role: "gridcell"}).css(h).addClass("ui-first-th-" + this.p.direction).appendTo(l), k.style.width = "", h = r(e.name, b.groupHeaders), 0 <= h) {
                        h = b.groupHeaders[h];
                        d = h.numberOfColumns;
                        f = h.titleText;
                        for (h = e = 0; h < d && c + h < t; h++)
                            o[c + h].hidden || e++;
                        ...
                        0 === d ? b.useColSpanStyle ? g.attr("rowspan", "2") : (a("<th>", {role: "columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-" + this.p.direction).css({display: e.hidden ? "none" : "", "border-top": "0px none"}).insertBefore(g), i.append(k)) : (i.append(k), d--);
                        ...
                        if (0 <= i && h) {
                            ...
                            if (b.p.groupHeader) {
                                ...
                                a("tr.jqg-second-row-header th", c).each(function() {
                                    ...
                                    if (o = parseInt(a(this).attr("rowspan"), 10))
                                        k++, g++;
                                    f && (k += f, g++);
                                    if (k === i)
                                        return!1
...
(function(a) {
    a.extend(a.jgrid, {showModal: function(a) {
            ...
            if (c.drag)
                if (a(l).css("cursor", "move"), a.fn.jqDrag)
                    a(i).jqDrag(l);
                else
                    try {
                    ...
                    if (void 0 !== b.dataUrl) {
                                ...
                                if (b) {
                                    ...
                                    setTimeout(function() {
                                        a("option", c).each(function(b) {
                                            ...
                                            if (a.inArray(a.trim(a(this).text()), d) > -1 || a.inArray(a.trim(a(this).val()), d) > -1)
                        ...
                        if ("string" === typeof b.value) {
                            ...
                            for (k = 0; k < l.length; k++) {
                                ...
                                f.appendChild(e);
                                if (!d &&
                                        (a.trim(n[0]) === a.trim(c) || a.trim(n[1]) === a.trim(c)))
                                    e.selected = "selected";
                                if (d && (-1 < a.inArray(a.trim(n[1]), g) || -1 < a.inArray(a.trim(n[0]), g)))
                                    e.selected = "selected"
                            }
                            ...
                            for (k in m = b.value, m)
                                if (m.hasOwnProperty(k)) {
                                    ...
                                    e.innerHTML = m[k];
                                    f.appendChild(e);
                                    if (!d && (a.trim(k) === a.trim(c) || a.trim(m[k]) === a.trim(c)))
                                        e.selected = "selected";
                                    if (d && (-1 < a.inArray(a.trim(m[k]), g) || -1 < a.inArray(a.trim(k), g)))
                                        e.selected =
                                                "selected"
                                }
                        h(f, b, ["value"])
                ...
                case "custom":
                    ...
                    try {
                        if (a.isFunction(b.custom_element))
                            if (m = b.custom_element.call(i, c, b))
                                m = a(m).addClass("customelement").attr({id: b.id,
                                    name: b.name}), a(f).empty().append(m);
                            else
                                throw"e2";
                        else
                            throw"e1";
    ...
    a.jgrid.extend({searchGrid: function(b) {
            ...
            return this.each(function() {
                function c(c) {
                    ...
                    u && (a.jgrid.viewModal("#" + a.jgrid.jqID(q.themodal), {gbox: "#gbox_" + a.jgrid.jqID(h), jqm: b.jqModal, modal: b.modal, overlay: b.overlay, toTop: b.toTop}), a(e).triggerHandler("jqGridFilterAfterShow", [c]), a.isFunction(b.afterShowSearch) && b.afterShowSearch.call(e, c))
                }
                var e = this;
                if (e.grid) {
                    ...
                    if (void 0 !== a("#" + a.jgrid.jqID(q.themodal))[0])
                        ...
                        h = a.jgrid.jqID(h);
                        a("#" + h).jqFilter({columns: v, filter: b.loadDefaults ? o : null, showQuery: b.showQuery, errorcheck: b.errorcheck, sopt: b.sopt,
                        ...
                        a("#" + h + "_reset").bind("click", function() {
                            ...
                            r !== false && a(e).trigger("reloadGrid", [{page: 1}]);
                            b.closeAfterReset &&
                                    a.jgrid.hideModal("#" + a.jgrid.jqID(q.themodal), {gb: "#gbox_" + a.jgrid.jqID(e.p.id), jqm: b.jqModal, onClose: b.onClose});
                            return false
                        });
                        c(a("#" + h));
            ...
            c = a.extend(!0, {top: 0, left: 0, width: 300, datawidth: "auto", height: "auto", dataheight: "auto", modal: !1, overlay: 30, drag: !0, resize: !0, url: null, mtype: "POST", clearAfterAdd: !0, closeAfterEdit: !1,
                ...
                overlayClass: "ui-widget-overlay"}, a.jgrid.edit, c || {});
            b[a(this)[0].p.id] = c;
            return this.each(function() {
                function e() {
                        ...
                        if (c.length) {
                            ...
                            a.each(d.p.colModel, function() {
                                if (this.name === b && this.editoptions && a.isFunction(this.editoptions.custom_value)) {
                                    try {
                                        if (j[b] = this.editoptions.custom_value.call(d, a("#" + a.jgrid.jqID(b), l), "get"), void 0 === j[b])
                                            throw"e1";
                                    } catch (c) {
                ...
                function h(c, e, k, f) {
                    ...
                    a(e.p.colModel).each(function(p) {
                        ...
                        if ("cb" !== i && "subgrid" !== i && !0 === this.editable && "rn" !== i) {
                            if (!1 === z)
                                h = "";
                            else if (i === e.p.ExpandColumn && !0 === e.p.treeGrid)
                                h = a("td[role='gridcell']:eq(" + p + ")", e.rows[z]).text();
                            else {
                                try {
                                    h = a.unformat.call(e, a("td[role='gridcell']:eq(" + p + ")", e.rows[z]), {rowId: c, colModel: this}, p)
                                } catch (u) {
                                    h = this.edittype && "textarea" === this.edittype ? a("td[role='gridcell']:eq(" + p + ")", e.rows[z]).text() : a("td[role='gridcell']:eq(" + p + ")", e.rows[z]).html()
                                }
                                if (!h || "&nbsp;" === h || "&#160;" === h || 1 === h.length && 160 === h.charCodeAt(0))
                                    h =
                                            ""
                            }
                            var r = a.extend({}, this.editoptions || {}, {id: i, name: i}), q = a.extend({}, {elmprefix: "", elmsuffix: "", rowabove: !1, rowcontent: ""}, this.formoptions || {}), x = parseInt(q.rowpos, 10) || n + 1, w = parseInt(2 * (parseInt(q.colpos, 10) || 1), 10);
                    ...
                    if (0 < n && (p = a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='" + (2 * f - 1) + "' class='DataTD'><input class='FormElement' id='id_g' type='text' name='" + e.p.id + "_id' value='" +
                            c + "'/></td></tr>"), p[0].rp = n + 999, a(k).append(p), b[d.p.id].checkOnSubmit || b[d.p.id].checkOnUpdate))
                    ...
                    if ("_empty" === c)
                        ...
                        p && (a('td[role="gridcell"]', p).each(function(j) {
                            ...
                            if ("cb" !== k && "subgrid" !== k && "rn" !== k && !0 === m[j].editable) {
                                if (k === e.p.ExpandColumn && !0 === e.p.treeGrid)
                                    f = a(this).text();
                                else
                                    try {
                                ...
                                switch (m[j].edittype) {
                                    ...
                                    case "checkbox":
                                        ...
                                        if (m[j].editoptions && m[j].editoptions.value)
                                            if (m[j].editoptions.value.split(":")[0] === f)
                                                a("#" + k, "#" + g)[d.p.useProp ? "prop" : "attr"]({checked: !0, defaultChecked: !0});
                                            else
                                                a("#" + k, "#" + g)[d.p.useProp ? "prop" : "attr"]({checked: !1, defaultChecked: !1});
                                        else
                                            f = f.toLowerCase(), 0 > f.search(/(false|f|0|no|n|off|undefined)/i) && "" !== f ? (a("#" + k, "#" + g)[d.p.useProp ? "prop" : "attr"]("checked", !0), a("#" + k, "#" + g)[d.p.useProp ? "prop" : "attr"]("defaultChecked",
                                    ...
                                    case "custom":
                                        try {
                                            if (m[j].editoptions && a.isFunction(m[j].editoptions.custom_value))
                                                m[j].editoptions.custom_value.call(d, a("#" + k, "#" + g), "set", f);
                                            else
                                                throw"e1";
                                        } catch (l) {
                ...
                function q() {
                    ...
                    for (o in j)
                        if (j.hasOwnProperty(o) &&
                                (k = a.jgrid.checkValues.call(d, j[o], o), !1 === k[0]))
                            break;
                    r();
                    ...
                    if (k[0] && !b[d.p.id].processing) {
                        ...
                        if (!0 === d.p.treeGrid)
                            for (s in j[m] === i.addoper && (z = a(d).jqGrid("getGridParam", "selrow"), j["adjacency" === d.p.treeGridModel?d.p.treeReader.parent_id_field:"parent_id"] = z), d.p.treeReader)
                                d.p.treeReader.hasOwnProperty(s) && (f = d.p.treeReader[s], j.hasOwnProperty(f) && !(j[m] === i.addoper && "parent_id_field" ===
                                        s) && delete j[f]);
                        j[h] = a.jgrid.stripPref(d.p.idPrefix, j[h]);
                        s = a.extend({url: b[d.p.id].url || a(d).jqGrid("getGridParam", "editurl"), type: b[d.p.id].mtype, data: a.isFunction(b[d.p.id].serializeEditData) ? b[d.p.id].serializeEditData.call(d, j) : j, complete: function(f, o) {
                                var s;
                                ...
                                if (k[0] === false) {
                                    ...
                                    if (j[m] === i.addoper) {
                                        ...
                                        if (b[d.p.id].closeAfterAdd) {
                                            ...
                                            a.jgrid.hideModal("#" + a.jgrid.jqID(n.themodal), {gb: "#gbox_" + a.jgrid.jqID(p), jqm: c.jqModal, onClose: b[d.p.id].onClose})
                                        } else
                                            b[d.p.id].clearAfterAdd && u("_empty", d, g)
                                    } else {
                                        if (b[d.p.id].reloadAfterSubmit) {
                                            ...
                                            d.p.treeGrid === true ? a(d).jqGrid("setTreeRow",
                                                    j[h], j) : a(d).jqGrid("setRowData", j[h], j);
                                        b[d.p.id].closeAfterEdit && a.jgrid.hideModal("#" + a.jgrid.jqID(n.themodal), {gb: "#gbox_" + a.jgrid.jqID(p), jqm: c.jqModal, onClose: b[d.p.id].onClose})
                                    }
                                    ...
                                    if (b[d.p.id].checkOnSubmit || b[d.p.id].checkOnUpdate) {
                                        ...
                                        if (b[d.p.id]._savedData[d.p.id + "_id"] !==
                                            ...
                                            for (s in b[d.p.id]._savedData)
                                                b[d.p.id]._savedData.hasOwnProperty(s) && j[s] && (b[d.p.id]._savedData[s] = j[s])
                                    }
                                }
                ...
                function f() {
                    var c = !0;
                    a("#FormError", l).hide();
                    if (b[d.p.id].checkOnUpdate && (j = {}, e(), K = o(j, b[d.p.id]._savedData)))
                        a("#" + g).data("disabled", !0), a(".confirm", "#" + n.themodal).show(), c = !1;
                    return c
                }
                function i() {
                    var c;
                ...
                if (d.grid && s) {
                    ...
                    if (void 0 !== a("#" + a.jgrid.jqID(n.themodal))[0]) {
                        ...
                        !0 === b[d.p.id].processing && (b[d.p.id].processing =
                                !1, a("#sData", l + "_2").removeClass("ui-state-active"));
                        ...
                        a.jgrid.viewModal("#" + a.jgrid.jqID(n.themodal), {gbox: "#gbox_" + a.jgrid.jqID(p), jqm: c.jqModal, jqM: !1, overlay: c.overlay, modal: c.modal, overlayClass: c.overlayClass});
                        ...
                        a("#" + a.jgrid.jqID(n.themodal)).keydown(function(e) {
                            ...
                            if (e.which === 27) {
                                if (!f())
                                    return false;
                                L && a.jgrid.hideModal("#" + a.jgrid.jqID(n.themodal), {gb: c.gbox, jqm: c.jqModal, onClose: b[d.p.id].onClose});
                                return false
                            }
                            if (b[d.p.id].navkeys[0] ===
                                    true) {
                                if (a("#id_g", l).val() === "_empty")
                                    return true;
                        ...
                        c.checkOnUpdate && (a("a.ui-jqdialog-titlebar-close span", "#" + a.jgrid.jqID(n.themodal)).removeClass("jqmClose"), a("a.ui-jqdialog-titlebar-close", "#" + a.jgrid.jqID(n.themodal)).unbind("click").click(function() {
                            if (!f())
                                return false;
                            a.jgrid.hideModal("#" + a.jgrid.jqID(n.themodal), {gb: "#gbox_" +
                        ...
                        a("#" + a.jgrid.jqID(n.themodal)).data("onClose",
                                b[d.p.id].onClose);
                        a.jgrid.viewModal("#" + a.jgrid.jqID(n.themodal), {gbox: "#gbox_" + a.jgrid.jqID(p), jqm: c.jqModal, overlay: c.overlay, modal: c.modal, overlayClass: c.overlayClass});
                        G || a("." + a.jgrid.jqID(c.overlayClass)).click(function() {
                            if (!f())
                                return false;
                            a.jgrid.hideModal("#" + a.jgrid.jqID(n.themodal), {gb: "#gbox_" + a.jgrid.jqID(p), jqm: c.jqModal, onClose: b[d.p.id].onClose});
            ...
            c = a.extend(!0, {top: 0, left: 0, width: 0, datawidth: "auto",
                height: "auto", dataheight: "auto", modal: !1, overlay: 30, drag: !0, resize: !0, jqModal: !0, closeOnEscape: !1, labelswidth: "30%", closeicon: [], navkeys: [!1, 38, 40], onClose: null, beforeShowForm: null, beforeInitData: null, viewPagerButtons: !0, recreateForm: !1}, a.jgrid.view, c || {});
            b[a(this)[0].p.id] = c;
            return this.each(function() {
                function e() {
                ...
                function h(b, d, e, f) {
                    ...
                    for (p = 1; p <= f; p++)
                        r += 1 === p ? q : "<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>";
                    a(d.p.colModel).each(function() {
                    ...
                    a(d.p.colModel).each(function(b) {
                        ...
                        if ("cb" !== g && "subgrid" !== g && "rn" !== g && A) {
                            ...
                            var c = a.extend({}, {rowabove: !1, rowcontent: ""}, this.formoptions || {}), k = parseInt(c.rowpos, 10) || n + 1, p = parseInt(2 * (parseInt(c.colpos, 10) || 1), 10);
                            if (c.rowabove) {
                ...
                function u(b, c) {
                    var d, e, f = 0, g, i;
                    if (i = a(c).jqGrid("getInd", b, !0))
                        a("td", i).each(function(b) {
                ...
                var o = this;
                if (o.grid && s) {
                    var f = o.p.id, i = "ViewGrid_" + a.jgrid.jqID(f), t = "ViewTbl_" + a.jgrid.jqID(f), v = "ViewGrid_" + f, d = "ViewTbl_" + f, p = {themodal: "viewmod" + f, modalhead: "viewhd" + f, modalcontent: "viewcnt" + f, scrollelm: i}, g = a.isFunction(b[o.p.id].beforeInitData) ? b[o.p.id].beforeInitData : !1, m = !0, l = 1, n = 0;
                    ...
                    if (void 0 !==
                        ...
                        a.jgrid.viewModal("#" + a.jgrid.jqID(p.themodal), {gbox: "#gbox_" + a.jgrid.jqID(f), jqm: c.jqModal, jqM: !1, overlay: c.overlay, modal: c.modal});
                        e()
                    } else {
                        ...
                        a("#" + p.themodal).keydown(function(d) {
                            if (d.which === 27) {
                                b[o.p.id].closeOnEscape && a.jgrid.hideModal("#" + a.jgrid.jqID(p.themodal), {gb: c.gbox, jqm: c.jqModal, onClose: c.onClose});
                                return false
                            }
                            if (c.navkeys[0] === true) {
                        ...
                        a.jgrid.viewModal("#" + a.jgrid.jqID(p.themodal), {gbox: "#gbox_" + a.jgrid.jqID(f), jqm: c.jqModal, overlay: c.overlay, modal: c.modal});
                        ...
                        a("#cData", "#" + t + "_2").click(function() {
                            a.jgrid.hideModal("#" + a.jgrid.jqID(p.themodal), {gb: "#gbox_" + a.jgrid.jqID(f), jqm: c.jqModal, onClose: c.onClose});
                            return false
                        });
            ...
            return this.each(function() {
                ...
                if (e.grid &&
                        s) {
                    var h = a.isFunction(b[e.p.id].beforeShowForm), u = a.isFunction(b[e.p.id].afterShowForm), r = a.isFunction(b[e.p.id].beforeInitData) ? b[e.p.id].beforeInitData : !1, q = e.p.id, o = {}, f = !0, i = "DelTbl_" + a.jgrid.jqID(q), t, v, d, p, g = "DelTbl_" + q, m = {themodal: "delmod" + q, modalhead: "delhd" + q, modalcontent: "delcnt" + q, scrollelm: i};
                    ...
                    if (void 0 !== a("#" + a.jgrid.jqID(m.themodal))[0]) {
                        ...
                        a.jgrid.viewModal("#" + a.jgrid.jqID(m.themodal), {gbox: "#gbox_" + a.jgrid.jqID(q), jqm: b[e.p.id].jqModal, jqM: !1, overlay: b[e.p.id].overlay, modal: b[e.p.id].modal})
                    } else {
                        ...
                        a("#dData", "#" + i + "_2").click(function() {
                            ...
                            if (f[0] && !b[e.p.id].processing) {
                                ...
                                g = a.extend({url: b[e.p.id].url || a(e).jqGrid("getGridParam", "editurl"), type: b[e.p.id].mtype, data: a.isFunction(b[e.p.id].serializeDelData) ? b[e.p.id].serializeDelData.call(e, t) : t, complete: function(d, g) {
                                        var n;
                                            ...
                                            if (b[e.p.id].reloadAfterSubmit && e.p.datatype !== "local")
                                                ...
                                                if (e.p.treeGrid === true)
                                                    ...
                                                    for (n = 0; n < h.length; n++)
                                                        a(e).jqGrid("delRowData", e.p.idPrefix + h[n]);
                                                e.p.selrow = null;
                                                e.p.selarrrow = []
                                            }
                                        ...
                                        f[0] && a.jgrid.hideModal("#" + a.jgrid.jqID(m.themodal), {gb: "#gbox_" + a.jgrid.jqID(q), jqm: c.jqModal, onClose: b[e.p.id].onClose})
                                ...
                                if (f[0])
                                    if (b[e.p.id].useDataProxy) {
                                        ...
                                        if (g[0] === false) {
                                            ...
                                            a.jgrid.hideModal("#" + a.jgrid.jqID(m.themodal), {gb: "#gbox_" + a.jgrid.jqID(q), jqm: c.jqModal, onClose: b[e.p.id].onClose})
                                    } else
                                        a.ajax(g)
                            }
                            if (f[0] === false) {
                        ...
                        a("#eData", "#" + i + "_2").click(function() {
                            a.jgrid.hideModal("#" + a.jgrid.jqID(m.themodal), {gb: "#gbox_" + a.jgrid.jqID(q), jqm: b[e.p.id].jqModal, onClose: b[e.p.id].onClose});
                            return false
                        });
                        h && b[e.p.id].beforeShowForm.call(e, a("#" + i));
                        a.jgrid.viewModal("#" +
            ...
            c = a.extend({edit: !0, editicon: "ui-icon-pencil", add: !0, addicon: "ui-icon-plus", del: !0, delicon: "ui-icon-trash", search: !0, searchicon: "ui-icon-search", refresh: !0, refreshicon: "ui-icon-refresh",
                refreshstate: "firstpage", view: !1, viewicon: "ui-icon-document", position: "left", closeOnEscape: !0, beforeRefresh: null, afterRefresh: null, cloneToTop: !1, alertwidth: 200, alertheight: "auto", alerttop: null, alertleft: null, alertzIndex: null}, a.jgrid.nav, c || {});
            return this.each(function() {
                if (!this.nav) {
                    var o = {themodal: "alertmod_" + this.p.id, modalhead: "alerthd_" + this.p.id, modalcontent: "alertcnt_" + this.p.id}, f = this, i;
                    if (f.grid && "string" === typeof b) {
                        void 0 === a("#" + o.themodal)[0] && (!c.alerttop && !c.alertleft && (void 0 !==
                                ...
                                {gbox: "#gbox_" + a.jgrid.jqID(f.p.id), jqModal: !0, drag: !0, resize: !0, caption: c.alertcap, top: c.alerttop, left: c.alertleft, width: c.alertwidth, height: c.alertheight, closeOnEscape: c.closeOnEscape, zIndex: c.alertzIndex}, "#gview_" + a.jgrid.jqID(f.p.id), a("#gbox_" + a.jgrid.jqID(f.p.id))[0], !0));
                        ...
                        for (v = 0; v < t; v++) {
                            ...
                            c.add && (h = h || {}, i = a("<td class='ui-pg-button ui-corner-all'></td>"), a(i).append("<div class='ui-pg-div'><span class='ui-icon " + c.addicon + "'></span>" + c.addtext + "</div>"), a("tr", g).append(i), a(i, g).attr({title: c.addtitle || "", id: h.id || "add_" + l}).click(function() {
                                a(this).hasClass("ui-state-disabled") || (a.isFunction(c.addfunc) ? c.addfunc.call(f) :
                                        a(f).jqGrid("editGridRow", "new", h));
                                return false
                            }).hover(d, p), i = null);
                            c.edit && (i = a("<td class='ui-pg-button ui-corner-all'></td>"), e = e || {}, a(i).append("<div class='ui-pg-div'><span class='ui-icon " + c.editicon + "'></span>" + c.edittext + "</div>"), a("tr", g).append(i), a(i, g).attr({title: c.edittitle || "", id: e.id || "edit_" + l}).click(function() {
                                if (!a(this).hasClass("ui-state-disabled")) {
                                    var b = f.p.selrow;
                                    if (b)
                                        a.isFunction(c.editfunc) ? c.editfunc.call(f, b) : a(f).jqGrid("editGridRow", b, e);
                                    else {
                                        a.jgrid.viewModal("#" +
                            ...
                            c.view && (i = a("<td class='ui-pg-button ui-corner-all'></td>"), q = q || {}, a(i).append("<div class='ui-pg-div'><span class='ui-icon " + c.viewicon + "'></span>" + c.viewtext + "</div>"), a("tr", g).append(i), a(i, g).attr({title: c.viewtitle || "", id: q.id || "view_" + l}).click(function() {
                                if (!a(this).hasClass("ui-state-disabled")) {
                                    var b = f.p.selrow;
                                    if (b)
                                        a.isFunction(c.viewfunc) ? c.viewfunc.call(f, b) : a(f).jqGrid("viewGridRow",
                                                b, q);
                                    else {
                                        a.jgrid.viewModal("#" + o.themodal, {gbox: "#gbox_" + a.jgrid.jqID(f.p.id), jqm: true});
                                        a("#jqg_alrt").focus()
                                    }
                                }
                                return false
                            }).hover(d, p), i = null);
                            c.del && (i = a("<td class='ui-pg-button ui-corner-all'></td>"), u = u || {}, a(i).append("<div class='ui-pg-div'><span class='ui-icon " + c.delicon + "'></span>" + c.deltext + "</div>"), a("tr", g).append(i), a(i, g).attr({title: c.deltitle || "", id: u.id || "del_" + l}).click(function() {
                                if (!a(this).hasClass("ui-state-disabled")) {
                                    var b;
                                    if (f.p.multiselect) {
                                        b = f.p.selarrrow;
                                        ...
                                        b = f.p.selrow;
                                    if (b)
                                        a.isFunction(c.delfunc) ? c.delfunc.call(f, b) : a(f).jqGrid("delGridRow", b, u);
                                    else {
                                        a.jgrid.viewModal("#" + o.themodal, {gbox: "#gbox_" + a.jgrid.jqID(f.p.id), jqm: true});
                                        a("#jqg_alrt").focus()
                                    }
                            ...
                            c.search && (i = a("<td class='ui-pg-button ui-corner-all'></td>"), r = r || {}, a(i).append("<div class='ui-pg-div'><span class='ui-icon " +
                                    c.searchicon + "'></span>" + c.searchtext + "</div>"), a("tr", g).append(i), a(i, g).attr({title: c.searchtitle || "", id: r.id || "search_" + l}).click(function() {
        ...
        navButtonAdd: function(b, c) {
            ...
            return this.each(function() {
                ...
                if (e.grid) {
                    ...
                    if (u)
                        for (h in u)
                            u.hasOwnProperty(h) && (a("[name=" + a.jgrid.jqID(h) + "]", c).is("input:radio") || a("[name=" + a.jgrid.jqID(h) + "]", c).is("input:checkbox") ? a("[name=" + a.jgrid.jqID(h) + "]", c).each(function() {
                                if (a(this).val() == u[h])
                                    a(this)[e.p.useProp ? "prop" : "attr"]("checked", !0);
                                else
                                    a(this)[e.p.useProp ? "prop" : "attr"]("checked",
                                            !1)
...
(function(a) {
    ...
    a.jgrid.extend({editRow: function(c, b, e, n, h, j, p, g, f) {
            var k = {}, d = a.makeArray(arguments).slice(1);
            if ("object" === a.type(d[0]))
                k = d[0];
            else if (void 0 !== b && (k.keys = b), a.isFunction(e) && (k.oneditfunc = e), a.isFunction(n) && (k.successfunc = n), void 0 !== h && (k.url = h), void 0 !== j && (k.extraparam = j), a.isFunction(p) && (k.aftersavefunc = p), a.isFunction(g) && (k.errorfunc = g), a.isFunction(f))
                k.afterrestorefunc = f;
            k = a.extend(!0, {keys: !1, oneditfunc: null, successfunc: null, url: null,
                extraparam: {}, aftersavefunc: null, errorfunc: null, afterrestorefunc: null, restoreAfterError: !0, mtype: "POST"}, a.jgrid.inlineEdit, k);
            return this.each(function() {
                var d = this, f, b, e = 0, g = null, h = {}, j, m, n;
                if (d.grid && (j = a(d).jqGrid("getInd", c, !0), !1 !== j && (n = a.isFunction(k.beforeEditRow) ? k.beforeEditRow.call(d, k, c) : void 0, void 0 === n && (n = !0), n && "0" === (a(j).attr("editable") || "0") && !a(j).hasClass("not-editable-row"))))
                    m = d.p.colModel, a('td[role="gridcell"]', j).each(function(l) {
                        f = m[l].name;
                        var j = !0 === d.p.treeGrid && f ===
                                d.p.ExpandColumn;
                        if (j)
                            b = a("span:first", this).html();
                        else
                            try {
                        ...
                        if (13 === f.keyCode) {
                            if ("TEXTAREA" === f.target.tagName)
                                return!0;
                            if (a(d).jqGrid("saveRow", c, k) && d.p._inlinenav)
                                try {
                                    a(d).jqGrid("showAddEditButtons")
                                } catch (e) {
                                }
            ...
            if ("object" === a.type(g[0]))
                f = g[0];
            else if (a.isFunction(b) && (f.successfunc = b), void 0 !== e && (f.url = e), void 0 !== n && (f.extraparam = n), a.isFunction(h) && (f.aftersavefunc = h), a.isFunction(j) && (f.errorfunc = j), a.isFunction(p))
                f.afterrestorefunc = p;
            var f = a.extend(!0, {successfunc: null, url: null, extraparam: {}, aftersavefunc: null, errorfunc: null, afterrestorefunc: null, restoreAfterError: !0, mtype: "POST"}, a.jgrid.inlineEdit, f), k = !1, d = this[0], o, i = {}, v = {}, r = {}, s, w, q;
            if (!d.grid)
                return k;
                ...
                if ("1" === g) {
                            ...
                            switch (m.edittype) {
                                ...
                                case "select":
                                    if (m.editoptions.multiple) {
                                        ...
                                        i[o] = a("select option:selected", this).val(), v[o] = a("select option:selected", this).text();
                                ...
                                case "custom":
                                    try {
                                        if (m.editoptions && a.isFunction(m.editoptions.custom_value)) {
                                            if (i[o] =
                                                    m.editoptions.custom_value.call(d, a(".customelement", this), "get"), void 0 === i[o])
                                                throw"e2";
                                        } else
                                            throw"e1";
                                    } catch (g) {
                    ...
                    if (!1 === w[0]) {
                        try {
                            ...
                            a.jgrid.info_dialog(a.jgrid.errors.errcap, w[1], a.jgrid.edit.bClose, {left: l[0], top: l[1] + a(t).outerHeight()})
                        } catch (x) {
                            alert(w[1])
                        }
                        return k
                    ...
                    if (i) {
                        ...
                        if (void 0 === i[l] || "" === i[l])
                            i[l] = c;
                        else if (q.id !== d.p.idPrefix + i[l] && (g = a.jgrid.stripPref(d.p.idPrefix, c), void 0 !== d.p._index[g] && (d.p._index[i[l]] = d.p._index[g], delete d.p._index[g]), c = d.p.idPrefix + i[l], a(q).attr("id", c), d.p.selrow === t && (d.p.selrow = c), a.isArray(d.p.selarrrow) && (g = a.inArray(t, d.p.selarrrow), 0 <= g && (d.p.selarrrow[g] = c)), d.p.multiselect))
                            g = "jqg_" + d.p.id + "_" + c, a("input.cbox", q).attr("id", g).attr("name", g);
            ...
            b = a.extend(!0, {edit: !0, editicon: "ui-icon-pencil", add: !0, addicon: "ui-icon-plus", save: !0, saveicon: "ui-icon-disk", cancel: !0, cancelicon: "ui-icon-cancel", addParams: {addRowParams: {extraparam: {}}}, editParams: {}, restoreAfterSelect: !0}, a.jgrid.nav, b || {});
            return this.each(function() {
                if (this.grid) {
                    ...
                    if (!0 === b.addParams.useFormatter) {
                        ...
                        for (p = 0; p < j.length; p++)
                            if (j[p].formatter && "actions" === j[p].formatter) {
                                j[p].formatoptions && (j = a.extend({keys: !1, onEdit: null, onSuccess: null, afterSave: null, onError: null, afterRestore: null, extraparam: {}, url: null}, j[p].formatoptions), b.addParams.addRowParams = {keys: j.keys, oneditfunc: j.onEdit, successfunc: j.onSuccess, url: j.url, extraparam: j.extraparam, aftersavefunc: j.afterSave, errorfunc: j.onError, afterrestorefunc: j.afterRestore});
                                break
                            }
                    }
                    b.add && a(e).jqGrid("navButtonAdd",
                            c, {caption: b.addtext, title: b.addtitle, buttonicon: b.addicon, id: e.p.id + "_iladd", onClickButton: function() {
                    ...
                    b.edit && a(e).jqGrid("navButtonAdd", c, {caption: b.edittext, title: b.edittitle, buttonicon: b.editicon, id: e.p.id + "_iledit", onClickButton: function() {
                            var c =
                                    a(e).jqGrid("getGridParam", "selrow");
                            c ? (a(e).jqGrid("editRow", c, b.editParams), a("#" + h + "_ilsave").removeClass("ui-state-disabled"), a("#" + h + "_ilcancel").removeClass("ui-state-disabled"), a("#" + h + "_iladd").addClass("ui-state-disabled"), a("#" + h + "_iledit").addClass("ui-state-disabled")) : (a.jgrid.viewModal("#alertmod", {gbox: "#gbox_" + h, jqm: !0}), a("#jqg_alrt").focus())
                        }});
                    ...
                    b.cancel &&
                            (a(e).jqGrid("navButtonAdd", c, {caption: b.canceltext || "", title: b.canceltitle || "Cancel row editing", buttonicon: b.cancelicon, id: e.p.id + "_ilcancel", onClickButton: function() {
    ...
    b.jgrid.extend({setSubGrid: function() {
            ...
            return this.each(function() {
                ...
                if (a.grid) {
                    ...
                    for (; n < r; )
                        b(a.rows[n]).hasClass("jqgrow") && b(a.rows[n].cells[d]).bind("click",
                                function() {
    ...
    e.jgrid.extend({groupingSetup: function() {
                ...
                if (null !== a && ("object" === typeof a ||
                    ...
                    if (a.groupField.length) {
                        ...
                        for (b = 0; b < a.groupField.length; b++)
                            a.groupOrder[b] || (a.groupOrder[b] = "asc"), a.groupText[b] || (a.groupText[b] = "{0}"), "boolean" !== typeof a.groupColumnShow[b] && (a.groupColumnShow[b] = !0), "boolean" !== typeof a.groupSummary[b] && (a.groupSummary[b] = !1), !0 === a.groupColumnShow[b] ? (a.visibiltyOnNextGrouping[b] = !0, e(this).jqGrid("showCol", a.groupField[b])) : (a.visibiltyOnNextGrouping[b] =
                                    e("#" + e.jgrid.jqID(this.p.id + "_" + a.groupField[b])).is(":visible"), e(this).jqGrid("hideCol", a.groupField[b]));
                        a.summary = [];
                        b = 0;
                        for (g = f.length; b < g; b++)
                            f[b].summaryType && (f[b].summaryDivider ? a.summary.push({nm: f[b].name, st: f[b].summaryType, v: "", sd: f[b].summaryDivider, vd: "", sr: f[b].summaryRound, srt: f[b].summaryRoundType || "round"}) : a.summary.push({nm: f[b].name, st: f[b].summaryType, v: "", sr: f[b].summaryRound, srt: f[b].summaryRoundType || "round"}))
                    } else
                        this.p.grouping = !1;
                else
                    this.p.grouping = !1
            ...
            this.each(function() {
                ...
                for (c = 0; c < l; c++)
                    m = d.groupField[c], k = d.displayField[c], i = f[m], k = null == k ? null : f[k], null == k && (k = i), void 0 !== i && (0 === a ? (d.groups.push({idx: c, dataIndex: m, value: i, displayValue: k, startRow: a, cnt: 1, summary: []}), d.lastvalues[c] = i, d.counters[c] = {cnt: 1, pos: d.groups.length - 1, summary: e.extend(!0, [], d.summary)}) : "object" !== typeof i && (e.isArray(d.isInTheSameGroup) && e.isFunction(d.isInTheSameGroup[c]) ? !d.isInTheSameGroup[c].call(h,
                            ...
                            function() {
                                if (e.isFunction(this.st))
                                    this.v = this.st.call(h, this.v, this.nm, f);
                                else {
                                    this.v = e(h).jqGrid("groupingCalculations.handler", this.st, this.v, this.nm, this.sr, this.srt, f);
                                    if (this.st.toLowerCase() === "avg" && this.sd)
                                        this.vd = e(h).jqGrid("groupingCalculations.handler", this.st, this.vd, this.sd, this.sr, this.srt, f)
                                }
            ...
            this.each(function() {
                ...
                var d = f.join("_"), f = g.minusicon, h = g.plusicon, c = e("#" + e.jgrid.jqID(b)), c = c.length ? c[0].nextSibling : null, l = e("#" + e.jgrid.jqID(b) + " span.tree-wrap-" + this.p.direction), m = function(a) {
                    a = e.map(a.split(" "), function(a) {
                        if (a.substring(0, d.length + 1) === d + "_")
                            return parseInt(a.substring(d.length + 1), 10)
                    });
                ...
                if (l.hasClass(f)) {
                    if (g.showSummaryOnHide) {
                        if (c)
                            for (; c && !(e(c).hasClass("jqfoot") && parseInt(e(c).attr("jqfootlevel"), 10) <= a); )
                                e(c).hide(), c =
                                        c.nextSibling
                    } else if (c)
                        for (; c; ) {
            ...
            return this.each(function() {
                ...
                for (a = 0; a < b.length; a++)
                    f.visibiltyOnNextGrouping[a] = e("#" + e.jgrid.jqID(this.p.id) + "_" + e.jgrid.jqID(b[a])).is(":visible");
            ...
            return this.each(function() {
                ...
                if (!0 === b) {
                    ...
                    for (f = 0; f < g.groupField.length; f++)
                        !g.groupColumnShow[f] && g.visibiltyOnNextGrouping[f] &&
