...
!function(a) {
    ...
    function b(a, b) {
        ...
        c.settings = b, c.queue = {interval: "i", min: "measure create", max: "measure create", now: "now create", select: "parse create validate", highlight: "create validate", view: "create validate", disable: "flipItem", enable: "flipItem"}, c.item = {}, c.item.interval = b.interval || 30, c.item.disable = (b.disable || []).slice(0), c.item.enable = -function(a) {
            ...
            var d = a.$root.children(), e = d.find("." + b.klass.viewset);
            e.length ? d[0].scrollTop = ~~(e.position().top - 2 * e[0].clientHeight) : console.warn("Nothing to viewset with", c.item.view)
        }).on("open", function() {
    ...
    b.prototype.set = function(a, b, c) {
        ...
        return this.item[a]
    }, b.prototype.create = function(b, e, g) {
        var h = this;
        return e = void 0 === e ? b : e, a._.isObject(e) && a._.isInteger(e.pick) ? e = e.pick : $.isArray(e) ? e = +e[0] * d + +e[1] : a._.isInteger(e) || (e = h.now(b, e, g)), "max" == b && e < h.item.min.pick && (e += f), e = h.normalize(e, g), {hour: ~~(c + e / d) % c, mins: (d + e % d) % d, time: (f + e) % f, pick: e}
    }, b.prototype.now = function(b, c) {
        var e = new Date, f = e.getHours() * d + e.getMinutes();
        return a._.isInteger(c) ? c += "min" == b && 0 > c && 0 === f ? 2 : 1 : c = 1, c * this.item.interval + f
    }, b.prototype.normalize = function(a) {
        return a - ((0 > a ? this.item.interval : 0) + a % this.item.interval)
    }, b.prototype.measure = function(b, e, f) {
        var g = this;
        return e ? e === !0 || a._.isInteger(e) ? e = g.now(b, e, f) : a._.isObject(e) && a._.isInteger(e.pick) && (e = g.normalize(e.pick, f)) : e = "min" == b ? [0, 0] : [c - 1, d - 1], e
    }, b.prototype.validate = function(a, b, c) {
        ...
        var c = this, d = c.item.disable.filter(function(d) {
            return a._.isInteger(d) ? b.hour == d : $.isArray(d) ? b.pick == c.create(d).pick : void 0
        }).length;
        return-1 === c.item.enable ? !d : d
    }, b.prototype.shift = function(a, b) {
        for (var c = this; c.disabled(a) && (a = c.create(a.pick += b || c.item.interval), !(a.pick <= c.item.min.pick || a.pick >= c.item.max.pick)); )
            ;
        return a
    }, b.prototype.scope = function(a) {
        ...
        return f.formats.toArray(e.format).map(function(b) {
            var d = f.formats[b], e = d ? a._.trigger(d, f, [c, g]) : b.replace(/^!/, "").length;
            d && (g[b] = c.substr(0, e)), c = c.substr(e)
        }), +g.i + d * (+(g.H || g.HH) || +(g.h || g.hh) % 12 + (/^p/i.test(g.A || g.a) ? 12 : 0))
    }, b.prototype.formats = {h: function(b, c) {
            return b ? a._.digits(b) : c.hour % e || e
        }, hh: function(b, c) {
            return b ? 2 : a._.lead(c.hour % e || e)
        }, H: function(b, c) {
            ...
            return a ? 4 : f / 2 > b.time % f ? "a.m." : "p.m."
        }, A: function(a, b) {
            return a ? 2 : f / 2 > b.time % f ? "AM" : "PM"
        }, toArray: function(a) {
        ...
        return a._.node("ul", a._.group({min: c.item.min.pick, max: c.item.max.pick, i: c.item.interval, node: "li", item: function(b) {
            ...
            }}) + a._.node("li", a._.node("button", d.clear, d.klass.buttonClear, "data-clear=1" + (b ? "" : " disable"))), d.klass.list)
    ...
    }(a.klasses().picker), a.extend("pickatime", b)
});