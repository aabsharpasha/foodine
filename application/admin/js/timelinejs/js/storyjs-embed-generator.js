 ...
 ********************************************** *//* Support Timeline Embed Generator web form (becomes storyjs-embed-generator.js) */function getScriptPath(e) {
    var t = document.getElementsByTagName("script"), n = "";
    for (var r = 0; r < t.length; r++)
        t[r].src.match(e) && (n = t[r].src);
...
function getLinkAndIframe() {
    ...
    y = "<iframe src='" + w + "'";
    if (n.value > 0 || n.value.match("%"))
        y += " width='" + n.value + "'";
    if (r.value > 0 || r.value.match("%"))
        y += " height='" + r.value + "'";
