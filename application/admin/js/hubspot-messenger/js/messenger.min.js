...
(function() {
    ...
    var i = e.forEach, o = (e.map, e.reduce, e.reduceRight, e.filter), a = (e.every, e.some, e.indexOf, e.lastIndexOf, Array.isArray, Object.keys), l = n.bind, u = {}, c = {}, h = u.each = u.forEach = function(e, t, n) {
        if (null != e)
            if (i && e.forEach === i)
                ...
                for (var o in e)
                    if (u.has(e, o) && t.call(n, e[o], o, e) === c)
                        return
    };
                    ...
                    if (e = a[l], r = this._events[e]) {
                        if (o = [], n || s)
                            for (c = 0, h = r.length; h > c; c++)
                                i = r[c], (n && n !== i.callback && n !== i.callback._callback || s && s !== i.context) && o.push(i);
                        this._events[e] = o
                    }
                return this
            }, trigger: function(e) {
    ...
    e = jQuery, i = null != (l = window._) ? l : window.Messenger._, s = null != (u = "undefined" != typeof Backbone && null !== Backbone ? Backbone.Events : void 0) ? u : window.Messenger.Events, n = function() {
        ...
        return p(n, t), n.prototype.defaults = {hideAfter: 10, scroll: !0}, n.prototype.initialize = function(t) {
            ...
            for (r in i)
                t = i[r], s = e.extend({}, t), s.name = r, null == (o = s.label) && (s.label = r), n.push(s);
            return n
            ...
            for (o = e("<div class='messenger-message message alert " + t.type + " message-" + t.type + " alert-" + t.type + "'>"), t.showCloseButton && (r = e('<button type="button" class="messenger-close" data-dismiss="alert">&times;</button>'), r.click(function() {
                return p.cancel(), !0
            }), o.append(r)), a = e('<div class="messenger-message-inner">' + t.message + "</div>"), o.append(a), t.actions.length && (s = e('<div class="messenger-actions">')), h = t.actions, u = 0, c = h.length; c > u; u++)
                l = h[u], n = e("<span>"), n.attr("data-action", "" + l.name), i = e("<a>"), i.html(l.label), n.append(e('<span class="messenger-phrase">')), n.append(i), s.append(n);
            return o.append(s), o
        }, n.prototype.render = function() {
            var t;
            if (!this.rendered)
                return this._hasSlot || (this.setElement(this.messenger._reserveMessageSlot(this)), this._hasSlot = !0), t = e.extend({}, this.options, {actions: this.parseActions()}), this.$message = e(this.template(t)), this.$el.html(this.$message), this.shown = !0, this.rendered = !0, this.trigger("render")
        }, n
    }(n), r = function(e) {
        function t() {
        ...
        return p(t, e), t.prototype.initialize = function() {
            ...
            if (null == this._timers[e])
                return n = this.$message.find("[data-action='" + e + "'] .messenger-phrase"), s = null != (i = t.delay) ? i : 3, 10 >= s ? (this.$message.removeClass("messenger-retry-later"), this.$message.addClass("messenger-retry-soon")) : (this.$message.removeClass("messenger-retry-soon"), this.$message.addClass("messenger-retry-later")), r = function() {
                    var i;
        ...
        return p(n, t), n.prototype.tagName = "ul", n.prototype.className = "messenger", n.prototype.messageDefaults = {type: "info"}, n.prototype.initialize = function(t) {
            ...
            if (null != e.options.id)
                for (i = this.history, n = 0, s = i.length; s > n; n++)
                    if (t = i[n], r = t.msg, null != r.options.id && r.options.id === e.options.id && e !== r) {
            ...
            var e, t, n, s, r, i, o;
            for (s = !0, t = null, e = !1, o = this.history, r = 0, i = o.length; i > r; r++)
                n = o[r], n.$slot.removeClass("messenger-first messenger-last messenger-shown"), n.msg.shown && n.msg.rendered && (n.$slot.addClass("messenger-shown"), e = !0, t = n, s && (s = !1, n.$slot.addClass("messenger-first")));
        ...
        return p(n, t), n.prototype.doDefaults = {progressMessage: null, successMessage: null, errorMessage: "Error connecting to the server.", showSuccessWithoutError: !0, retry: {auto: !0, allow: !0}, action: e.ajax}, n.prototype.hookBackboneAjax = function(t) {
            ...
            null == e && (e = {}), i = {};
            for (r in e)
                s = e[r], n = r.indexOf(" "), o = r.substring(0, n), t = r.substring(n + 1), null == (a = i[o]) && (i[o] = {}), i[o][t] = s;
            return i
        }, n.prototype._normalizeResponse = function() {
            var e, t, n, s, r, o, a;
            for (n = arguments.length >= 1?d.call(arguments, 0):[], s = null, r = null, e = null, o = 0, a = n.length; a > o; o++)
                t = n[o], "success" === t || "timeout" === t || "abort" === t ? s = t : null != (null != t ? t.readyState : void 0) && null != (null != t ? t.responseText : void 0) ? r = t : i.isObject(t) && (e = t);
            return[s, e, r]
            ...
            if (l = arguments[0], h = arguments[1], t = arguments.length >= 3 ? d.call(arguments, 2) : [], null == h && (h = {}), l = e.extend(!0, {}, this.messageDefaults, this.doDefaults, null != l ? l : {}), s = this._parseEvents(l.events), r = function(e, t) {
                ...
                for (g in a)
                    o = a[g], c = h[g], h[g] = o;
            for (u._actionInstance = l.action.apply(l, [h].concat(d.call(t))), l.returnsPromise && u._actionInstance.then(a.success, a.error), p = ["done", "progress", "fail", "state", "then"], m = 0, v = p.length; v > m; m++)
                n = p[m], null != u[n] && delete u[n], u[n] = null != (_ = u._actionInstance) ? _[n] : void 0;
            return u
