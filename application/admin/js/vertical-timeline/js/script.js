...
$(function() {
    ...
    function setupTimeline(data, tabletop) {
        ...
        var layout_mode;
        if (width < 769) {
            layout_mode = 'straightDown';
        }
        else {
            layout_mode = 'spineAlign';
        }
    ...
    function handleIsotopeStretch() {
        var width = $(window).width();
        if (width < 769) {
            $('#timeline').isotope('reloadItems').isotope({layoutMode: 'straightDown'});
            console.log('----------------------------------------------------------> Resize straightDown');
        }
        else {
            $('#timeline').isotope('reloadItems').isotope({layoutMode: 'spineAlign'});
            console.log('----------------------------------------------------------> Resize spineAlign');
        }
    }
...
/*
 * Isotope custom layout mode straightDown
 */

$.Isotope.prototype._straightDownReset = function() {
    this.straightDown = {
        y: 0
    };
},
        $.Isotope.prototype._straightDownLayout = function($elems) {
    var instance = this;
    $elems.each(function(i) {
        ...
        $.Isotope.prototype._straightDownGetContainerSize = function() {
