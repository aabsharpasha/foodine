    ...
    <body>
                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="clearfix">
                                            <h3 class="content-title pull-left">
                                                ...
                                                echo $record_set_restaurant['vRestaurantName'] . "'s Menu Images";
                                                ?>
                                            </h3>
                                        </div>
                                        <div class="description">Menu Listing</div>
                                    </div>
                                </div>
                            </div>
        ...
        <script>
            ...
            if (iRestaurantID == '')
                ...
                url = controller + '/paginate/' + iRestaurantID;
            ...
            $(document).ready(function()
            {
                ...
                var target = [
                    {
                        ...
                        "mRender": function(data, type, full)
                        {
                            ...
                            if (full['eStatus'] == "Active") {
                                buttons += '<a title="Click here to inactive" id="atag' + full['iMenuPictureID'] + '" onclick="return changeStatus(' + data + ',' + "'" + controller + "/status/" + full['iMenuPictureID'] + "/y'" + ')"  class="btn btn-success marginright10 margintop10"><i class="fa fa-check-circle-o"></i> Active </a>'
                            } else {
                                buttons += '<a title="Click here to Active" id="atag' + full['iMenuPictureID'] + '" onclick="return changeStatus(' + data + ',' + "'" + controller + "/status/" + full['iMenuPictureID'] + "/y'" + ')"  class="btn btn-inverse marginright10 margintop10"><i class="fa fa-times-circle-o "></i> Inactive </a>'
                            }
                            return buttons;
                        }
                    },
                ...
                var aoculumn = [
                    /*0*/ {"mData": "vPictureName", bSortable: false, bSearchable: false, "sWidth": "60%"},
                    /*1*/ {"mData": "tCreatedAt", "sWidth": "30%"},
                    /*2*/ {"mData": "iMenuPictureID", bSortable: false, bSearchable: false, "sWidth": "10%"}
                ];
