...
<html lang="en-us">
    ...
    <body>
                            ...
                            <div id="divtoappend" class="row">
                                <div class="col-sm-12">
                                    <div class="page-header">
                                        ...
                                        <div class="description">Restaurant Reported By User</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="box border primary">
                                        <div class="box-title">
                                            <h4><i class="fa fa-eye"></i>Restaurant Reported By User List</h4>
                                            <div class="tools ">
        ...
        <script>
            ...
            var url;
            url = controller + '/paginate_restaurantReportedByUser';
            ...
            $(document).ready(function () {
                ...
                var target = [
                    {
                        ...
                        "mRender": function (data, type, full) {
                            ...
                            if (full['is_accepted'] === "1") {
                                buttons += '<a id="status' + full['iReportErrorId'] + '"  onclick="return changeAcceptedStatus(' + "'" + controller + "/reportedByUserStatus/" + full['iReportErrorId'] + "/y'" + ', \'status' + full['iReportErrorId'] + '\')"  class="btn btn-success btn-xs  marginright10 margintop10"><i class="fa fa-check-circle"></i> Accepted </a>';
                            }else{
                                buttons += '<a id="status' + full['iReportErrorId'] + '"  onclick="return changeAcceptedStatus(' + "'" + controller + "/reportedByUserStatus/" + full['iReportErrorId'] + "/y'" + ', \'status' + full['iReportErrorId'] + '\')"  class="btn btn-inverse btn-xs  marginright10 margintop10"><i class="fa fa-check-circle"></i> Not Accepted </a>';
                            }
                            return buttons;
                        }
                    }
                ...
                var aoculumn = [
                    ...
                    /*2*/ {"mData": "isWrongPhone", "sWidth": "15%"},
                    /*3*/ {"mData": "isWrongAddress", "sWidth": "15%"},
                    /*4*/ {"mData": "isWrongMenu", "sWidth": "15%"},
                    /*5*/ {"mData": "isWrongOthers", "sWidth": "20%"},
                    /*6*/ {"mData": "iRemarks", "sWidth": "15%"},
                    /*7*/ {"mData": "tCreatedAt", "sWidth": "15%"},
                    /*8*/ {"mData": "iReportErrorId", "sWidth": "15%"}
                ];
