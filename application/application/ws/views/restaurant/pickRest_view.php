                            ...
                            <div id="divtoappend" class="row">
                                <div class="col-sm-12">
                                    <div class="page-header">
                                        ...
                                        <div class="clearfix">
                                            <h3 class="content-title pull-left">Recommended <?php echo $this->uppercase; ?></h3>
                                        </div>
                                        <div class="description">Recommended Restaurant</div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12 main-rest-list-cms" >
                                    <div class="box border primary">
                                        ...
                                        <div class="box-body big">
                                            <?php
                                            echo form_open("restaurant/saveHandpicksRestaurants", $form_attr);
                                            ?>
