...
<html lang="en-us">
    ...
    <body>
                            ...
                            <div id="divtoappend" class="row">
                                <div class="col-sm-12">
                                    <div class="page-header">
                                        ...
                                        <div class="description">Information Change Reported By User</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="box border primary">
                                        <div class="box-title">
                                            <h4><i class="fa fa-eye"></i>Information Change Reported By User List</h4>
                                            <div class="tools ">
        ...
        <script>
            ...
            var url;
            url = controller + '/paginate_infoChangeReportedByUser';
                ...
                var target = [
                    {
                        ...
                        "mRender": function (data, type, full) {
                            ...
                            if (full['is_accepted'] === "1") {
                                buttons += '<a id="status' + full['iEditReqID'] + '"  onclick="return changeAcceptedStatus(' + "'" + controller + "/infoChangeReportedByUserStatus/" + full['iEditReqID'] + "/y'" + ', \'status' + full['iEditReqID'] + '\')"  class="btn btn-success btn-xs  marginright10 margintop10"><i class="fa fa-check-circle"></i> Accepted </a>';
                            }else{
                                buttons += '<a id="status' + full['iEditReqID'] + '"  onclick="return changeAcceptedStatus(' + "'" + controller + "/infoChangeReportedByUserStatus/" + full['iEditReqID'] + "/y'" + ', \'status' + full['iEditReqID'] + '\')"  class="btn btn-inverse btn-xs  marginright10 margintop10"><i class="fa fa-check-circle"></i> Not Accepted </a>';
                            }
                            return buttons;
                        }
                    }
