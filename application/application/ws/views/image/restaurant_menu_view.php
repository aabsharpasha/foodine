    ...
    <body>
                            ...
                            <div id="divtoappend" class="row">
                                <div class="col-sm-12">
                                    <div class="page-header">
                                        ...
                                        <div class="description">Restaurant Menu Image Listing</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="box border primary">
                                        <div class="box-title">
                                            <h4><i class="fa fa-table"></i>Restaurant Menu Image list</h4>
                                            <div class="tools">
                                                <a href="<?= BASEURL . $this->controller . '/restaurant_menu_add/' . $iRestaurantID; ?>" class="">
                                                    Add New
                                                </a>
        ...
        <script>
            var oTable,
                    ...
                    imagepath = '<?php echo RESTAURANT_MENU_IMAGE_PATH ?>',
            ...
            if (iRestaurantID == '')
                url = controller + '/restaurant_menu_paginate';
            else
                url = controller + '/restaurant_menu_paginate/' + iRestaurantID;
            ...
            $(document).ready(function () {
                ...
                var target = [
                    {
                        ...
                        "mRender": function (data, type, full)
                        {
                            ...
                            var buttons = ' <a title="Edit" href="<?= BASEURL ?>' + controller + '/restaurant_menu_add/' + iRestaurantID + '/' + full['iMenuPictureID'] + '/y"  class="btn btn-primary marginright10 margintop10 "><i class="fa fa-pencil-square-o"></i> Edit </a> \n <button title="Delete" class="btn btn-danger marginright10 margintop10"  onclick="return validateRemove(' + data + ',' + "'" + controller + "/deleteRestaurantMenu/'" + ');"><i class="fa fa-times"></i> Delete</button>';
                            if (full['eStatus'] === "Active") {
                                buttons += '<a title="Click here to inactive" id="atag' + full['iMenuPictureID'] + '" onclick="return changeStatus(' + data + ',' + "'" + controller + "/menu_status/" + full['iMenuPictureID'] + "/y'" + ')"  class="btn btn-success marginright10 margintop10"><i class="fa fa-check-circle-o"></i> Active </a>'
                            } else {
                                buttons += '<a title="Click here to Active" id="atag' + full['iMenuPictureID'] + '" onclick="return changeStatus(' + data + ',' + "'" + controller + "/menu_status/" + full['iMenuPictureID'] + "/y'" + ')"  class="btn btn-inverse marginright10 margintop10"><i class="fa fa-times-circle-o "></i> Inactive </a>'
                            }
                            return buttons;
                        }
                    },
                ...
                var aoculumn = [
                    ...
                    /*0*/ {"mData": "eMenuType", "sWidth": "60%"},
                    /*1*/ {"mData": "tCreatedAt", "sWidth": "30%"},
                    /*2*/ {"mData": "iMenuPictureID", bSearchable: false, "sWidth": "10%"}
                ];
                getdatatable(controller + '/deleteRestaurantMenu', url, aoculumn, target, 3, 'ASC');
            });
        </script>
