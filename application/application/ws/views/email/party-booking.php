                ...
                <tr>
                    <td>
                        <table cellspacing="0" cellpadding="0" border="0" width="100%" bgcolor="#f58220" style="background:#f58220;">
                            ...
                            <tr>
                                <td>
                                    <table cellspacing="0" cellpadding="0" border="0" width="100%" bgcolor="#fde6d2" style="background:#fde6d2;">
                                        <tr>
                                            <td width="64" style="background: #f58220;"><img width="1" height="1" alt="" src="%BASEURL%/images/blank.gif"></td>
                                            <td>
                                                <table cellspacing="0" cellpadding="0" border="0" width="325" align="center">
                                                   <tr><td height="10"><img width="1" height="1" alt="" src="%BASEURL%/images/blank.gif"></tr>  
                                                   <tr><td style="font-family: Arial, Helvetica, sans-serif; font-size: 18px; line-height: 1; color: #58595b; font-weight: bold; text-align: center;">Hi  <span>%USERNAME%</span> </td></tr>
                                                   <tr><td height="48"><img width="1" height="1" alt="" src="%BASEURL%/images/blank.gif"></tr>  
                                                   <tr><td style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 1.4; color: #333; text-align: center;">Every occasion in life is to be celebrated and we know exactly where you can do that. We want you to party till you drop and for that our experts are working on brining you the best locations and deals! Hold on tight! </td></tr>
                                                   <tr><td height="85"><img width="1" height="1" alt="" src="%BASEURL%/images/blank.gif"></tr>  
                                                   ...
                                                   <tr><td height="13"><img width="1" height="1" alt="" src="%BASEURL%/images/blank.gif"></tr>
                                                </table>   
                                            </td>
                                            <td width="64" style="background: #f58220;"><img width="1" height="1" alt="" src="%BASEURL%/images/blank.gif"></td>
                                        </tr> 
                                         <tr>
                                            ...
                                            <td style="background: #57585b">
                                                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                                    <tr>
                                                     <td width="27"><img src="%BASEURL%/images/core-left.jpg" alt=""></td>
                                                     <td style="font-family: Arial, Helvetica, sans-serif; font-size: 8px; line-height: 20px; color: #fff;">For help, please email us at <a href="#" style="color: #fff;">Support@foodine.com</a> / Call : 1800-11-8200</td>
                                                     <td width="25"><img src="%BASEURL%/images/core-right.jpg" alt=""></td>
                                                    </tr>  
                                                </table>  
                                            </td>
                                            <td width="64" style="background: #f58220;"><img width="1" height="1" alt="" src="%BASEURL%/images/blank.gif"></td>
                            ...
                            <tr><td height="8"><img width="1" height="1" alt="" src="%BASEURL%/images/blank.gif"></tr>         
                                ...
                                <tr>
                                   <td> 
                                    <table width="130" border="0" cellspacing="0" cellpadding="0" align="center" class="wrapper_table" border="0">
                                        <tr>
                                            <td align="center"><a href="#"><img src="%BASEURL%/images/fb.png" alt=""></a></td> 
                                            <td align="center"><a href="#"><img src="%BASEURL%/images/tw.png" alt=""></a></td> 
                                            <td align="center"><a href="#"><img src="%BASEURL%/images/pinterest.png" alt=""></a></td> 
                                        </tr>
                               ...
                               <tr><td height="16"><img width="1" height="1" alt="" src="%BASEURL%/images/blank.gif"></tr>             
                        </table>
