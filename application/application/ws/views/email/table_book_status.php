...
/*                color: #333 !important;*/
    ...
    <body style="background-color: #ffffff; font-family: Arial, Helvetica, sans-serif; font-size: 12px; color: #333; margin: 0;width:100% !important;" yahoo="fix" bgcolor="#ffffff">
        <div  class="page">
            ...
            <table width="500" border="0" cellspacing="0" cellpadding="0" align="center" class="wrapper_table" border="0" bgcolor="#fff">
                <tr>
                    <td>
                        <table  cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td><img src="%BASEURL%/images/email_images/banner.jpg" alt=""></td>   
                            </tr>
                            <tr>
                                <td>
                                    <table width="380" border="0" cellspacing="0" cellpadding="0" align="center" class="wrapper_table" border="0" bgcolor="#fff">
                                        ...
                                        <tr><td style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 1.3; color: #333;">Waiting to dine out with your folks? </tr> 
                                        <tr><td height="12"><img width="1" height="1" alt="" src="%BASEURL%/images/email_images/blank.gif"></tr>   
                                        <tr><td style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 1.3; color: #333;">We have forwarded your booking request, wait until your hear next from us. We will get back to you with your confirmation shortly! </tr> 
                           ...
                           <tr>
                               <td style="background: #4d4d4d;">    
                                <table  cellspacing="0" cellpadding="0" border="0" width="100%">    
                                    <tr>
                                       ...
                                       <td width="380" style="font-family: Arial, Helvetica, sans-serif; font-size: 11px; line-height: 20px; color: #fff;">For help, please email us at <a href="#" style="color: #fff;">Support@foodine.com</a> / Call : 9358393588</td>
                                       <td width="60"><img width="1" height="1" alt="" src="%BASEURL%/images/email_images/blank.gif"></td> 
                                    </tr>
                                 </table>
                              </td>
                                ...
                                <tr>
                                   <td> 
                                    <table width="195" border="0" cellspacing="0" cellpadding="0" align="center" class="wrapper_table" border="0" bgcolor="#fff">
                                        <tr>
                                ...
                                <tr>
                                   <td> 
                                    <table width="130" border="0" cellspacing="0" cellpadding="0" align="center" class="wrapper_table" border="0" bgcolor="#fff">
                                        <tr>
                               ...
                               <tr><td height="20"><img width="1" height="1" alt="" src="%BASEURL%/images/email_images/blank.gif"></tr>               
                        </table>
