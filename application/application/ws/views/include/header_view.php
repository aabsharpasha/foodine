...
//echo '<pre>';print_r($notification); die;
            //mprd($notification);
            //$notification = array();
            if (isset($notification) && ($this->session->userdata('ADMINTYPE') == 1 || $this->session->userdata('ADMINTYPE') == 2)) {
                ...
                <li class="dropdown">
				    ...
				    if(!empty($notification[$i]['recordField'])){
                            ...
                            ?>
                            <input type="hidden" id="lastNotifyId" value="<?= $notifyId; ?>" />
                            <?php
                        } else {
                            ?>
                        ...
                        ?>
                        <li class="footer">
                            <a href="<?= BASEURL; ?>notification">See All Notifications<i class="fa fa-angle-double-right"></i></a>
                        </li>
                    </ul>
                </li>
            <?php } ?>
