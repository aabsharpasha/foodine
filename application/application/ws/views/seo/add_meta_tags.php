...
$permission = get_page_permission($ADMINTYPE, 78);
...
$notify_id = array(
    "iRestaurantID" => isset($iRestaurantID) ? $iRestaurantID : ''
);
?>
<!doctype html>
<html lang="en-us">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="page-header">
                                        ...
                                        <div class="clearfix">
                                            <h3 class="content-title pull-left">SEO</h3>
                                        </div>
                                        <div class="description">Meta Tags</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="box border primary">
                                        <div class="box-title">
                                            <h4><i class="fa fa-plus-circle"></i>Edit Meta Tags</h4>
                                        ...
                                        <div class="box-body big">
                                            <?php
                                            echo form_open("seo/addMetaTags", $form_attr);
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <span><strong><?php echo $vRestaurantName;?></strong></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="margin0auto disptable">
                                                    ...
                                                    &nbsp;<a class="btn btn-sm btn-grey" href="<?= BASEURL .''. $this->controller; ?>/metaTags">Cancel</a>
                                                </div>
                                            </div>
                                            <?php echo form_close(); ?>
                                        </div>
