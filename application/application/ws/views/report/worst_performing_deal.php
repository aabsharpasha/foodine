...
$permission = get_page_permission($ADMINTYPE, 73);
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="page-header">
                                        ...
                                        <div class="description">Worst Performing Deals</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="box border primary">
                                        <div class="box-title">
                                            <h4><i class="fa fa-plus-circle"></i>Worst Performing Deals </h4>
                                        ...
                                        <div class="box-body big">
                                            <?php
                                            echo form_open("report/worstPerformingDealReport", $form_attr);
                                            ?>
        ...
        <script>
            ...
            function getRecords(){
                    $.ajax({
                        ...
                        url: BASEURL + controller + '/worstPerformingDealReport',
