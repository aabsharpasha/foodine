                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="box border primary">
                                        ...
                                        <div class="box-body big">
                                            <?php
                                            echo form_open("report/rankInLocalityReport", $form_attr);
                                            ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9 user-select">
                                                    <select class="form-control maxwidth500" name="iCategoryID" id="iCategoryID">
                                                        ...
                                                        <option value="<?php echo $category["iCategoryID"]; ?>" ><?php echo ucfirst($category["vCategoryName"]); ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
        ...
        <script>
            ...
            function getRecords(){
                    $.ajax({
                        ...
                        url: BASEURL + controller + '/rankInLocalityReport',
