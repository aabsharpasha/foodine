            ...
            <table border="0" cellpadding="0" cellspacing="0" width="98%">  
                <tbody>   
                    ...
                    <tr style="background:#e6e6e6">  
                        <td style="font-family:verdana;font-size:14px;line-height:1.3em;text-align:left;padding:0 15px 15px 15px" align="left" valign="top">  
                            <table width="100%">  
                                <tbody>
                                    <tr style="background:#f5f5f5;border-radius:5px">  
                                        <td stytle="font-family:verdana;font-size:13px;line-height:1.3em;text-align:left;padding:15px">    
                                            <p style="color:#8d8d8d">
                                                ...
                                                Thank you for selecting Hunger Mafia. We have received your Party Request. We will get in touch with you soon. 
                                                <br /> Please email us on support@hungermafia.com for any queries related to your order. 
                                            </p>
                                            <p>
                                                <h5>Details Received</h5>
                                                <p>%DATA%</p>
                                            </p>
                                            <p>  Thanks,
                                                <br/>HungerMafia Team
