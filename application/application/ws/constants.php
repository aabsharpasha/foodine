...
define('REVIEW_IMG', IMG_URL . 'restaurentReview/');
...
define('CHECKIN_FAIL', 'Your checkin has been failed.');
define('TABLE_BOOK_ERROR', 'First you have to book the table for this restaurant.');
define('CHECKIN_ALREADY', 'You have already checked in to this restaurant.');

define('REVIEW_FOUND_SUCC', 'Review found successfully.');
define('OFFER_FOUND_SUCC', 'Offer found successfully.');
define('PERSON_FOUND_SUCC', 'Min Max allowed persons found successfully.');
