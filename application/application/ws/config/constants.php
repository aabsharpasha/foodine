...
define('WEB_USER_FORGOT_PASSWORD', 'http://ec2-52-76-52-224.ap-southeast-1.compute.amazonaws.com/hungermafia/public/password/verify/');
...
define('BASEURL',"http://foodine.in/application/ws/");
//define('BASEURL', 'https://www.hungermafia.com/hm/application/');
define('BASEDIR', $_SERVER['DOCUMENT_ROOT'] . '/application/ws');
