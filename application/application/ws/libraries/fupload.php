...
class FUpload {
    ...
    public function __construct($fileObj = array()) {
        ...
        $this->fBasePath = UPLOADS;    // BASE DIRECTORY AT THERE YOU WANT TO UPLOAD YOUR FILE...
        $this->defaultRatio = 150;      // IMAGE RESIZE DEFAULT RATIO BASED ON THIS IMAGE WILL RESIZE..
        $this->fCompressQuality = 100;   // IMAGE COMPRESSION QUALITY...
    ...
    private function _fInitFileType() {
        try {
            switch ($this->fType) {
                ...
                case 'all' :
                    $this->fUploadType = 'gif|jpg|png|jpeg|mp4|wmv|mkv|3gp|avi|txt|pdf|doc|docx|ppt|rar|jar|exe|zip';
                    break;
