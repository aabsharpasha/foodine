...
abstract class REST_Controller extends CI_Controller {
    ...
    public function _remap($object_called, $arguments) {
        ...
        if( (strtolower($this->router->fetch_class())!="payumoney" || !in_array(strtolower($this->router->fetch_method()), array("success","failure"))) && (strtolower($this->router->fetch_class())!="paytm" || !in_array(strtolower($this->router->fetch_method()), array("verifychecksum","generatechecksum"))) && (strtolower($this->router->fetch_class())!="cron" || !in_array(strtolower($this->router->fetch_method()), array("sendnotification")))&& (strtolower($this->router->fetch_class())!="cronsend" || !in_array(strtolower($this->router->fetch_method()), array("main")))){
