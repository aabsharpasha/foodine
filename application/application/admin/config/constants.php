...
/*
  ...
  |
 */
define('IMGURL',"http://foodine.in/application/ws/images");
...
define('DOMAIN_URL', 'http://' . $_SERVER['SERVER_NAME'] . '/application');
define('DOC_ROOT', $_SERVER['DOCUMENT_ROOT'] . '/application/ws');
define('BASEURL', DOMAIN_URL . '/admin/index.php/');
define('BASEURLSANSINDEX', DOMAIN_URL . '/admin/');
define('gmapkey', '');
...
/* URL AND PATH FOR IMAGES  */
/* URL FOR CSS AND JS */
define('CSS_URL', BASEURLSANSINDEX);
define('PLUGIN_URL', BASEURLSANSINDEX . "plugins/");
define('JS_URL', BASEURLSANSINDEX);
define('JS_URL_GEO', BASEURLSANSINDEX . "js/");
define('DESIGN_PLUGIN_URL', BASEURLSANSINDEX . "plugins/");
/* URLS FOR FILE UPLOADED */
define('UPLOADS', DOC_ROOT . "/images/");
define('MENUUPLOADS', DOC_ROOT.'/uploads/');
...
define('DIR_LIB', DOC_ROOT . '/application/admin/libraries/');
...
define('USER_IMAGE_PATH', IMGURL . "/user/");
...
define('RESTAURANT_IMAGE_PATH', IMGURL . "/restaurant/");
//define('CUISINE_IMAGE_PATH', DOMAIN_URL . "/images/cuisine/");
define('CUISINE_IMAGE_PATH', IMGURL . "/cuisine/");
//define('EVENT_IMAGE_PATH', DOMAIN_URL . "/images/event/");
define('EVENT_IMAGE_PATH', IMGURL . "/event/");
//define('CATEGORY_IMAGE_PATH', DOMAIN_URL . "/images/category/");
define('CATEGORY_IMAGE_PATH', IMGURL. "/category/");
//define('RESTAURANT_PHOTO_IMAGE_PATH', DOMAIN_URL . "/images/restaurantPhoto/");
define('RESTAURANT_PHOTO_IMAGE_PATH', IMGURL . "/restaurantPhoto/");
define('RESTAURANT_PHOTO_IMAGE_PATH_ADMIN', DOMAIN_URL . "/ws/uploads/restaurantPhoto/");
//define('RESTAURANT_MENU_IMAGE_PATH', DOMAIN_URL . "/images/restaurantMenu/");
define('RESTAURANT_MENU_IMAGE_PATH', DOMAIN_URL . "/ws/uploads/restaurantMenu/");
//define('REWARD_IMAGE_PATH', DOMAIN_URL . "/images/reward/");
define('REWARD_IMAGE_PATH', IMGURL . "/reward/");
//define('QRCODE_IMAGE_PATH', DOMAIN_URL . "/images/qrcode/");
define('QRCODE_IMAGE_PATH', IMGURL . "/qrcode/");
...
/* Event Settings */
define('EVENT_ADDED', 'Events details are successfully added');
define('EVENT_NOT_ADDED', 'Failed to add event details, Please try again!');
define('EVENT_EXISTS', 'Email ID already exist!');
define('EVENT_EDITED', 'Evants details are successfully updated');
define('EVENT_NOT_EDITED', 'Failed to update event details, Please try again!');
...
define('DEAL_IMAGE_PATH', IMGURL . "/deal/");

//define('COMBOOFFER_IMAGE_PATH', DOMAIN_URL . "/images/combo/");
define('COMBOOFFER_IMAGE_PATH', IMGURL . "/combo/");
...
define('POINTS_EDITED', 'Points edited successfully.');
define('POINTS_NAME_EXISTS', 'Points name already exists.');

/* End of file constants.php */
/* Location: ./system/application/config/constants.php */


define('NOTIFICATION_ADDED', 'Notification sent successfully');
define('NOTIFICATION_NOT_ADDED', 'Notification can not send.');
define('NOTIFICATION_NAME_EXISTS', 'Notification name already exists');

define('REFERAL_ADD', 'Reference code added successfully');
define('REFERAL_EDIT', 'Reference code edited successfully.');
define('REFERAL_EXISTS', 'Reference code already exists');

define('IS_NOTIFICATION_LIVE', TRUE);
define('TOPIC_ARN', 'arn:aws:sns:ap-southeast-1:224401661599:broadcast');
define('CC_EMAIL_ID', 'restaurant@hungermafia.com');


/* SMSLANE */
define('SMSLANE_USERNAME', 'hungermafia');
define('SMSLANE_PASSWORD', 'hungermafia1');
define('SMSLANE_SMSID', 'WebSms');
define('SMSLANE_SMSFLAG', '0');
define('SMSLANE_POST_URL', 'http://www.smslane.com/vendorsms/pushsms.aspx');
define('SMSLANE_OWN_URL', 'http://www.hungermafia.com');

/* Sponsors Settings */
define('SPONSORS_ADDED', 'Sponsors details are successfully added');
define('SPONSORS_NOT_ADDED', 'Failed to add Sponsors details, Please try again!');
define('SPONSORS_EDITED', 'Sponsors details are successfully updated');
define('SPONSORS_NOT_EDITED', 'Failed to update Sponsors details, Please try again!');
define('SPONSORS_DELETED', 'Sponsors removed successfully');
define('SPONSORS_NOT_DELETED', 'Failed to remove Sponsors, Please try again!');


/* We are hiring Settings */
define('TEAM_ADDED', 'Team Member detail added successfully');
define('TEAM_EDITED', 'Team Member detail edited successfully');
define('MEMBER_NAME_EXISTS', 'Member name already exist!');
//define('TEAM_IMAGE_PATH', DOMAIN_URL . "/images/weAreHiringTeam/");
define('TEAM_IMAGE_PATH', IMGURL . "/weAreHiringTeam/");

//define('RESUME_PATH', DOMAIN_URL . "/images/resume/");
define('RESUME_PATH', IMGURL . "/resume/");

define('JOB_ADDED', 'Job detail added sucessfully');
define('JOB_NOT_ADDE', 'Somthing went wrong, please try again');

define('JOB_EDITED', 'Job detail edited sucessfully');
define('JOB_NOT_EDITED', 'Somthing went wrong, please try again');
/* hiring Settings */