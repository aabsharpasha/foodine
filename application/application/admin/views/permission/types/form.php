...
$submit_attr = array(
    ...
    'value' => $ACTION_LABEL == 'Edit' ? 'Save Changes' : "$ACTION_LABEL Role",
    'type' => 'submit'
);
$cancel_attr = array(
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="page-header">
                                        ...
                                        <div class="clearfix">
                                            <h3 class="content-title pull-left">Permission Role</h3>
                                        </div>
                                        <div class="description">Add/Edit Permission Role</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="box border primary">
                                        <div class="box-title">
                                            <h4><i class="fa fa-plus-circle"></i><?php echo $ACTION_LABEL . " Permission Role"; ?></h4>
                                        ...
                                        <div class="box-body big">
                                            <?php
                                            echo form_open("permission/add_type", $form_attr);
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control maxwidth500" name="vAdminTitle" value="<?php echo (isset($vAdminTitle) && $vAdminTitle != '') ? $vAdminTitle : ''; ?>">
                                                </div>
                                            </div> <br/>
                                            ...
                                            <div class="form-group">
                                                <div class="margin0auto disptable">
                                                    ...
                                                    <a class="btn btn-sm btn-grey" href="<?= BASEURL .''. $this->controller; ?>/types">Cancel</a>
                                                </div>
                                            </div>
                                            <?php echo form_close(); ?>
                                        </div>
