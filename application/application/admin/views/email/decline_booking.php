                            ...
                            <tr>
                                <td>
                                    <table width="380" border="0" cellspacing="0" cellpadding="0" align="center" class="wrapper_table" border="0" bgcolor="#fff">
                                        ...
                                        <tr><td height="15"><img width="1" height="1" alt="" src="%BASEURL%images/email_images/blank.gif"></tr> 
                                        <tr><td style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 1.3; color: #58595b;">We regret to inform that your booking has been declined. Hang on chum, you have more choices than you think. Just a gentle click here: <a href="https://www.hungermafia.com/" style="color: #58595b;">https://www.hungermafia.com/</a> and you can pick from the various other dining options we've got for you.</td></tr>            
                                        <tr><td height="8"><img width="1" height="1" alt="" src="%BASEURL%images/email_images/blank.gif"></tr>         
                               ...
                               <td style="background: #4d4d4d;">    
                                <table  cellspacing="0" cellpadding="0" border="0" width="100%">    
                                    <tr>
                                       ...
                                       <td width="380" style="font-family: Arial, Helvetica, sans-serif; font-size: 11px; line-height: 20px; color: #fff;">For help, please email us at <a href="#" style="color: #fff;">Support@hungermafia.com</a> / Call : 9358393588</td>
                                       <td width="60"><img width="1" height="1" alt="" src="%BASEURL%images/email_images/blank.gif"></td> 
                                    </tr>
                                 </table>
                              </td>
