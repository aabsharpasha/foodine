                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content modal-table">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">Sponsors Record</h4>
                                        </div>
        ...
        <script>
           var oTable, controller = '<?php echo $this->controller; ?>', imagepath = '<?php echo COMBOOFFER_IMAGE_PATH ?>', no_img_url = '<?php echo DOMAIN_URL; ?>/admin/img/no-image.png';
            ...
            $(document).ready(function () {
                ...
                var target = [
                    {
                        ...
                        "mRender": function (data, type, full) {
                            /*<a title="Edit" href="<?= BASEURL ?>' + controller + '/add/' + data + '/y"  class="btn btn-primary marginright10 "><i class="fa fa-pencil-square-o"></i> Edit </a>\n\*/
                             var buttons = ' <a title="Edit" href="<?= BASEURL ?>' + controller + '/add/' + full['iSponserId'] + '/y"  class="btn btn-sm btn-primary marginright10 margintop10 "><i class="fa fa-pencil-square-o"></i> Edit </a>';
                            if (btn_show_hide) {
                                ...
                                if (full['eStatus'] === "Active") {
                                    buttons += '<a title="Click here to inactive" id="atag' + full['iSponserId'] + '" onclick="return changeStatus(' + data + ',' + "'" + controller + "/status/" + full['iSponserId'] + "/y'" + ')"  class="btn btn-sm btn-success  marginright10 margintop10"><i class="fa fa-check-circle-o"></i> Active </a>'
                                } else {
                                    buttons += '<a title="Click here to Active" id="atag' + full['iSponserId'] + '" onclick="return changeStatus(' + data + ',' + "'" + controller + "/status/" + full['iSponserId'] + "/y'" + ')"  class="btn btn-sm btn-inverse  marginright10 margintop10"><i class="fa fa-times-circle-o "></i> Inactive </a>'
                                }
                            }
                            return buttons;
                        }
                    },
                    {
                        ...
                        "mRender": function (data, type, full) {
                            var buttons = '';
                            buttons += '<a href="#table-modal" data-toggle="modal" class="btn btn-sm btn-primary marginright10 margintop10 btn-view-detail" data-id="' + full['iSponserId'] + '">View Detail</a>';
                ...
                var aoculumn = [
//                    /*0*/ {"mData": "iSponserKeywords", "sWidth": "35%"},
                    /*1*/ {"mData": "vRestaurantName", "sWidth": "25%"},
//                    /*2*/ {"mData": "vDaysAllow", "sWidth": "25%"},
                    /*2*/ {"mData": "iSponserKeywords", "sWidth": "25%"},
                    /*2*/ {"mData": "dtStartDate", "sWidth": "25%"},
                    /*3*/ {"mData": "dtExpiryDate", "sWidth": "25%"},
                    /*4*/ {"mData": "Detail", "sWidth": "10%"},
                    /*5*/ {"mData": "iSponserId", bSortable: false, bSearchable: false, "sWidth": "10%"}
                ];
