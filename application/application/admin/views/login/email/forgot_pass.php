...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <style>
            * {margin: 0;padding: 0;font-family: "Helvetica Neue", "Helvetica", Helvetica, Arial, sans-serif;font-size: 100%;line-height: 1.6;}
            img {max-width: 100%;}
            body {-webkit-font-smoothing: antialiased;-webkit-text-size-adjust: none;width: 100%!important;height: 100%;margin: 0 auto;}
            a {color: #348eda;}
            ...
            .btn-secondary {text-decoration: none;color: #FFF;background-color: #aaa;border: solid #aaa;border-width: 10px 20px;line-height: 2;font-weight: bold;margin-right: 10px;text-align: center;cursor: pointer;display: inline-block;border-radius: 25px;}
    ...
    <body bgcolor="#f6f6f6">
        <table class="body-wrap" bgcolor="#f6f6f6" width="90%">
            <tr>
                <td></td>
                            ...
                            <tr>
                                <td>
                                    <table>
                                        <tr>
                                            <td>
                                                <img style="min-height:70px;margin:5px" src="%LOGO_IMAGE%"/>
                                            </td>
                                        </tr>
                                    </table>
                                    <h2> Hello,</h2>
                                    <p>Congratulations! Your password has been changed successfully.</p>
                                    <p>You can Login to our system using below details:</p>
                                    <table>
                                        <tr>
                                            <td class="padding">
                                                <p><a href="%CMS_LOGIN_LINK%" class="btn-primary">%CMS_LOGIN_LINK%</a></p>
                                            </td>
                                        </tr>
                                    </table>
                                    <table>
                                    ...
                                    <p>Happy to hear from you! If any further queries please email us on <a href="mailto:info@blacklist.com"> info@blacklist.com</a> </p>
                                </td>
                            </tr>
                        </table>
                    </div>
