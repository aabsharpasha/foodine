                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="page-header">
                                        ...
                                        <div class="description">Direct Search Report</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="box border primary">
                                        <div class="box-title">
                                            <h4><i class="fa fa-plus-circle"></i>Direct Search Report</h4>
                                        ...
                                        <div class="box-body big">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label" for="searchText">Select Restaurant<span class="required">*</span></label>
                                                <div class="col-sm-9 user-select">
                                                    <select class="form-control maxwidth500" name="searchText" id="searchText">
                                                        ...
                                                        <option value="<?php echo $restaurant["vRestaurantName"]; ?>" ><?php echo ucfirst($restaurant["vRestaurantName"]); ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
        ...
        <script>
            ...
            function getReportData(){
                $.ajax({
                    ...
                    url: BASEURL + controller + '/directSearchReport',
