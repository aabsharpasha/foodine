                            ...
                            <div id="divtoappend" class="row">
                                <div class="col-sm-12">
                                    <div class="page-header">
                                        ...
                                        <div class="clearfix">
                                            <h3 class="content-title pull-left">Party Booking</h3>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="box border primary">
                                        <div class="box-title">
                                            <h4><i class="fa fa-eye"></i>Party Booking List</h4>
                                            <div class="tools ">
                                            ...
                                            <table id="datatable" cellpadding="0" cellspacing="0" border="0" class="datatable table  table-bordered ">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Mobile</th>
                                                        <th>No. of People</th>
                                                        <th>Min Price Range</th>
                                                        <th>Max Price Range</th>
                                                        <th>Preferred Location1</th>
                                                        <th>Preferred Restaurant1</th>
<!--                                                        <th>Preferred Location2</th>
                                                        <th>Preferred Restaurant2</th>
                                                        <th>Preferred Location3</th>
                                                        <th>Preferred Restaurant3</th>-->
                                                        <th>Occasion</th>
							<th>Created Date</th>
                                                        <th>Date</th>
                                                        <th>Time</th>
...
<!--                                                        <th>Preferred Location2</th>
        ...
        <script>
            ...
            var url;
            url = controller + '/paginate_partyRequests';
            ...
            $(document).ready(function () {
                ...
                var aoculumn = [
                    ...
                    /*0*/ {"mData": "accountName", "sWidth": "20%"},
                    /*0*/ {"mData": "mobile", "sWidth": "20%"},
                    /*1*/ {"mData": "iNumberOfPeople", "sWidth": "20%"},
                    /*4*/ {"mData": "dMinPrice", "sWidth": "15%"},
                    /*5*/ {"mData": "dMaxPrice", "sWidth": "15%"},
                    /*6*/ {"mData": "iRestaurantID1", "sWidth": "10%"},
                    /*7*/ {"mData": "iRestaurantID2", "sWidth": "10%"},
                    /*8*/ {"mData": "vOcassion", "sWidth": "10%"},
		           /*2*/ {"mData": "createdDate", "sWidth": "20%"},
                    /*2*/ {"mData": "dtBookingDate", "sWidth": "20%"},
                    /*3*/ {"mData": "timeSlot", "sWidth": "15%"},
                    /*9*/ {"mData": "eStatus", "sWidth": "10%"},
                    /*10*/ {"mData": "iBookPartyID", bSortable: false, bSearchable: false, "sWidth": "15%"},
                    
                    

                ];
                var delete_val = btn_show_hide == 1 ? controller + '/deleteAllPartyBooking' : '';
                getdatatable(delete_val, url, aoculumn, target, 13, 'desc');
