...
<html lang="en-us">
    ...
    <body>
                            ...
                            <div id="divtoappend" class="row">
                                <div class="col-sm-12">
                                    <div class="page-header">
                                        ...
                                        <div class="description">Featured Banner Listing</div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="box border primary">
                                        <div class="box-title">
                                            ...
                                            <?php echo anchor('banner/add/featured', '<h5><i class="fa fa-plus-circle">&nbsp;Add Banner</i></h5>', 'id="fa-plus-circle"  class="colorfff pull-right"'); ?>
        ...
        <script>
            ...
            var url;
            url = controller + '/paginate/featured';
