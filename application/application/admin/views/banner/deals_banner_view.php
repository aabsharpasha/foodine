                            ...
                            <div id="divtoappend" class="row">
                                <div class="col-sm-12">
                                    <div class="page-header">
                                        ...
                                        <div class="description">Deals Banner Listing</div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="box border primary">
                                        <div class="box-title">
                                            ...
                                            <?php echo anchor('banner/add/deals', '<h5><i class="fa fa-plus-circle">&nbsp;Add Banner</i></h5>', 'id="fa-plus-circle"  class="colorfff pull-right"'); ?>
                                            <div class="tools ">
