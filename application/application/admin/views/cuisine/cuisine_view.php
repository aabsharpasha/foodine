    ...
    <body>
                            ...
                            <div id="divtoappend" class="row">
                                <div class="col-sm-12">
                                    <div class="page-header">
                                        ...
                                        <div class="description">Cuisines Listing</div>
                                    </div>
                                </div>
                            </div>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                var target = [
                    {
                        ...
                        "mRender": function(data, type, full) {
                            ...
                            if (permission.indexOf('2') >= 0) {
                                buttons += ' <a title="Edit" href="<?= BASEURL; ?>' + controller + '/add/' + full['iCuisineID'] + '/y"  class="btn btn-sm btn-primary marginright10 margintop10 "><i class="fa fa-pencil-square-o"></i> Edit </a> ';
                            }
                            ...
                            if (permission.indexOf('4') >= 0) {
                                if (full['eStatus'] == "Active") {
                                    buttons += '<a title="Click here to inactive" id="atag' + full['iCuisineID'] + '" onclick="return changeStatus(' + data + ',' + "'" + controller + "/status/" + full['iCuisineID'] + "/y'" + ')"  class="btn btn-sm btn-success marginright10 margintop10"><i class="fa fa-check-circle-o"></i> Active </a>'
                                } else {
                                    buttons += '<a title="Click here to Active" id="atag' + full['iCuisineID'] + '" onclick="return changeStatus(' + data + ',' + "'" + controller + "/status/" + full['iCuisineID'] + "/y'" + ')"  class="btn btn-sm btn-inverse marginright10 margintop10"><i class="fa fa-times-circle-o "></i> Inactive </a>'
                                }
                            }
                            return buttons;
                        }
                    },
                    {
                        ...
                        "mRender": function(data, type, full) {
                            if (full['total_restaurants'] == "0") {
                                ...
                                var buttons = ' <a title="View Restaurants" href="#table-modal" data-toggle="modal" class="btn btn-sm btn-primary marginright10 margintop10 btn-view-detail" data-id="' + full['iCuisineID'] + '"><i class="fa fa-pencil-square-o"></i> View Restaurants ( ' + full['total_restaurants'] + ' ) </a>';
                                //var buttons = ' <a title="View Restaurants" href="javascript:void(0)" class="btn btn-sm btn-primary marginright10 margintop10 " ><i class="fa fa-pencil-square-o"></i> View Restaurants ( ' + full['total_restaurants'] + ' ) </a>';
                            }
                            return buttons;
                        }
                    ...
                    },
                    {
                        ...
                        "mRender": function(data, type, full)
                        {
                            if (full['vCuisineImage'] != '') {
                                return '<a class="fancybox" rel="group" href="' + imagepath + full['iCuisineID'] + '/' + full['vCuisineImage'] + '"><img class="thumbnail img-responsive" src="' + imagepath + full['iCuisineID'] + '/thumb/' + full['vCuisineImage'] + '"  height="70" width="90" /></a>';
                            } else {
                ...
                var aoculumn = [
                    /*0*/ {"mData": "vCuisineName", "sWidth": "25%"},
                    /*0*/ {"mData": "iCuisineID", bSortable: false, bSearchable: false, "sWidth": "15%"},
                    /*1*/ {"mData": "total_restaurants", "sWidth": "15%", bSortable: false},
                    /*2*/ {"mData": "tCreatedAt1", "sWidth": "20%"},
                    /*3*/ {"mData": "iCuisineID", bSortable: false, bSearchable: false, "sWidth": "25%"}
                ];
