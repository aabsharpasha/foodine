...
if (isset($getCuisineData) && $getCuisineData != '')
    extract($getCuisineData);

$ADMINTYPE = $this->session->userdata('ADMINTYPE');
$permission = get_page_permission($ADMINTYPE, 23);

//print_r($getCuisineData);
...
$hiddeneditattr = array(
    "action" => "backoffice.cuisineedit"
);
$hiddenaddattr = array(
    "action" => "backoffice.cuisineadd"
);
$cuisine_id = array(
    "iCuisineID" => (isset($iCuisineID) && $iCuisineID != '') ? $iCuisineID : ''
);
$submit_attr = array(
    'class' => 'submit btn-sm btn btn-primary marginright20',
    'value' => $ACTION_LABEL == 'Edit' ? 'Save Changes' : "$ACTION_LABEL Cuisine",
    'type' => 'submit'
);
$cancel_attr = array(
...
$pic = (isset($vCuisineImage) && $vCuisineImage != '') ? $vCuisineImage : '';
$uid = (isset($iCuisineID) && $iCuisineID != '') ? $iCuisineID : '';
?>
<!doctype html>
<html lang="en-us">
    <head>
    ...
    <body>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="page-header">
                                        ...
                                        <div class="clearfix">
                                            <h3 class="content-title pull-left">Cuisine</h3>
                                        </div>
                                        <div class="description">Add/Edit Cuisine</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="box border primary">
                                        <div class="box-title">
                                            <h4><i class="fa fa-plus-circle"></i><?php echo $ACTION_LABEL . " Cuisine"; ?></h4>
                                        ...
                                        <div class="box-body big">
                                            <?php
                                            echo form_open("cuisine/add", $form_attr);
                                            if (isset($iCuisineID) && $iCuisineID != '') {
                                                echo form_hidden($cuisine_id);
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Cuisine Name <span class="required">*</span></label>
                                                <div class="col-sm-9">
                                                    <input class="form-control maxwidth500" name="vCuisineName" value="<?php echo (isset($vCuisineName) && $vCuisineName != '') ? $vCuisineName : ''; ?>">
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Cuisine Image</label>
                                                <div class="col-sm-9">

                                                    <?php
                                                    if ($pic != '' && $uid != '') {
                                                        $pic_str = '<img src="' . IMGURL . '/cuisine/' . $uid . '/thumb/' . $pic . '">';
                                                    ...
                                                    <div class="fileinput <?php echo $change_div; ?> " data-provides="fileinput">
                                                        ...
                                                        <input type="hidden" name="vCuisineUrl" value="<?php echo $pic; ?>"/>
                                                        <div>
        ...
        <script>
            var cusId = parseInt('<?= (isset($iCuisineID) && $iCuisineID != '') ? $iCuisineID : 0; ?>');
            jQuery(document).ready(function () {
                ...
                $("#validateForm").validate({
                    ...
                    messages: {
                        vCuisineName: "Please enter a Cuisine Name",
                    }
                });
