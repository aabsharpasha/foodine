        ...
        <div class="col-lg-12 padding0 margin0auto pos-relative text-justify">
            <div class="row padding0 margin0auto">
                <div class="col-lg-12 padding0 margin0auto">
                    <h1 class="padding0 margin0auto"><?= $viewData['vOfferTitle']; ?></h1>
                    <h4><?= $viewData['tOfferDetail']; ?></h4>
...
<div class="col-lg-12 padding0 margin0auto">
                    Actual Price: <label><?= $viewData['tActualPrice']; ?></label>
                </div>
<div class="col-lg-12 padding0 margin0auto">
                    Discounted Price: <label><?= $viewData['tDiscountedPrice']; ?></label>
                </div>
<div class="col-lg-12 padding0 margin0auto">
                    Commission: <label><?= $viewData['dCommission']; ?></label>
                </div>
