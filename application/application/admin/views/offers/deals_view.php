...
<!--                                                        <th>Days Allow</th>-->
        ...
        <script>
           var oTable, controller = '<?php echo $this->controller; ?>', imagepath = '<?php echo COMBOOFFER_IMAGE_PATH ?>', no_img_url = '<?php echo IMGURL; ?>/admin/img/no-image.png';
            var url;
            url = controller + '/paginate';
            var menuImageUrl    = '<?php echo DOMAIN_URL; ?>/admin/'+controller +'/offer_menu/';
                ...
                var target = [
                    {
                        ...
                        "mRender": function (data, type, full) {
                            ...
                            var buttons = ' <a title="Variants" href="<?= BASEURL ?>' + controller + '/suboffers/' + full['iComboOffersID'] + '"  class="btn btn-sm btn-primary marginright10 margintop10 "><i class="fa fa-pencil-square-o"></i> View Sub Offers </a>';
                    ...
                    },
                    {
                        ...
                        "mRender": function (data, type, full) {
                            ...
                            buttons += '<a href="#table-modal1" data-toggle="modal" class="btn btn-sm btn-primary marginright10 margintop10 btn-view-purchase-history" data-id="' + full['iComboOffersID'] + '">View Purchase History ( ' + full['total_purchase'] + ' )</a>';
                            buttons += '<a href="#table-modal2" data-toggle="modal" class="btn btn-sm btn-primary marginright10 margintop10 btn-view-redeem-history" data-id="' + full['iComboOffersID'] + '">View Redeem History ( ' + full['total_redeem'] + ' )</a>';
                            buttons += '<a href="'+menuImageUrl + full['iComboOffersID']+'"  class="btn btn-sm btn-primary marginright10 margintop10">Menu Images ( '+full["total_menu_images"]+' )</a>';
