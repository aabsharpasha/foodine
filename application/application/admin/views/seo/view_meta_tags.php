...
<html lang="en-us">
    ...
    <body>
                            ...
                            <div id="divtoappend" class="row">
                                <div class="col-sm-12">
                                    <div class="page-header">
                                        ...
                                        <div class="description">Meta Tags Listing</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="box border primary">
                                        <div class="box-title">
                                            <h4><i class="fa fa-eye"></i><?php echo $this->uppercase; ?> Meta Tags List</h4>
                                            <div class="tools ">
        ...
        <script>
            ...
            var url;
            url = controller + '/paginateMetaTags';
                ...
                var target = [
                    {
                        ...
                        "mRender": function (data, type, full) {
                            var buttons = ' <a title="Edit" href="<?= BASEURL; ?>' + controller + '/addMetaTags/' + full['iRestaurantID'] + '"  class="btn btn-sm btn-primary marginright10 margintop10 "><i class="fa fa-pencil-square-o"></i> Edit </a>';
                            return buttons;
                        }
                    }
                ];
