...
$permission = get_page_permission($ADMINTYPE, 22);
?>
<!doctype html>
<html lang="en-us">
    <head>
    ...
    <body>
                            ...
                            <div id="divtoappend" class="row">
                                <div class="col-sm-12">
                                    <div class="page-header">
                                        ...
                                        <div class="description">Collection Listing</div>
                                    </div>
                                </div>
                            </div>
        ...
        <script>
            var oTable, controller = '<?php echo $this->controller; ?>', imagepath = '<?php echo CUISINE_IMAGE_PATH ?>', no_img_url = '<?php echo IMGURL; ?>/admin/img/no-image.png';
            var url;
            ...
            $(document).ready(function() {
                ...
                var target = [
                    {
                        ...
                        "mRender": function(data, type, full) {
                            ...
                            if (permission.indexOf('2') >= 0) {
                                buttons += ' <a title="Edit" href="<?= BASEURL; ?>' + controller + '/add/' + full['iCollectionID'] + '/y"  class="btn btn-sm btn-primary marginright10 margintop10 "><i class="fa fa-pencil-square-o"></i> Edit </a> ';
                            }
                            ...
                            if (permission.indexOf('4') >= 0) {
                                if (full['eStatus'] == "Active") {
                                    buttons += '<a title="Click here to inactive" id="atag' + full['iCollectionID'] + '" onclick="return changeStatus(' + data + ',' + "'" + controller + "/status/" + full['iCollectionID'] + "/y'" + ')"  class="btn btn-sm btn-success marginright10 margintop10"><i class="fa fa-check-circle-o"></i> Active </a>'
                                } else {
                                    buttons += '<a title="Click here to Active" id="atag' + full['iCollectionID'] + '" onclick="return changeStatus(' + data + ',' + "'" + controller + "/status/" + full['iCollectionID'] + "/y'" + ')"  class="btn btn-sm btn-inverse marginright10 margintop10"><i class="fa fa-times-circle-o "></i> Inactive </a>'
                                }
                            }
                            return buttons;
                        }
                    },
                    {
                        ...
                        "mRender": function(data, type, full) {
                            if (full['total_restaurants'] == "0") {
                                ...
                                var buttons = ' <a title="View Restaurants" href="#table-modal" data-toggle="modal" class="btn btn-sm btn-primary marginright10 margintop10 btn-view-detail" data-id="' + full['iCollectionID'] + '"><i class="fa fa-pencil-square-o"></i> View Restaurants ( ' + full['total_restaurants'] + ' ) </a>';
                                //var buttons = ' <a title="View Restaurants" href="javascript:void(0)" class="btn btn-sm btn-primary marginright10 margintop10 " ><i class="fa fa-pencil-square-o"></i> View Restaurants ( ' + full['total_restaurants'] + ' ) </a>';
                            }
                            return buttons;
                        }
                    ...
                    },
                    {
                        ...
                        "mRender": function(data, type, full)
                        {
                            if (full['vCollectionImage'] != '') {
                                return '<a class="fancybox" rel="group" href="' + imagepath + full['iCollectionID'] + '/' + full['vCollectionImage'] + '"><img class="thumbnail img-responsive" src="' + imagepath + full['iCollectionID'] + '/thumb/' + full['vCollectionImage'] + '"  height="70" width="90" /></a>';
                            } else {
                ...
                var aoculumn = [
                    /*0*/ {"mData": "vCollectionName", "sWidth": "25%"},
                    /*0*/ {"mData": "iCollectionID", bSortable: false, bSearchable: false, "sWidth": "15%"},
                    /*1*/ {"mData": "total_restaurants", "sWidth": "15%", bSortable: false},
                    /*2*/ {"mData": "tCreatedAt1", "sWidth": "20%"},
                    /*3*/ {"mData": "iCollectionID", bSortable: false, bSearchable: false, "sWidth": "25%"}
                ];
