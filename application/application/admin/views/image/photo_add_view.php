...
$picture_id = array(
    "iPictureID" => (isset($iPictureID) && $iPictureID != '') ? $iPictureID : ''
);
$submit_attr = array(
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="page-header">
                                        ...
                                        <div class="clearfix">
                                            <h3 class="content-title pull-left">Restaurant Photo</h3>
                                        </div>
                                        <div class="description">Add / Edit Restaurant Photo</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="box border primary">
                                        <div class="box-title">
                                            <h4><i class="fa fa-bars"></i><?php echo $ACTION_LABEL . " Photo"; ?></h4>
                                        ...
                                        <div class="box-body big">
                                            <?php
                                            echo form_open("image/restaurant_image_add/" . $iRestaurantID, $form_attr);
                                            if (isset($iPictureID) && $iPictureID != '') {
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="file" name="res_image[]" 
                                                           accept="image/jpg, image/JPG,image/JPEG, image/jpeg, image/png, image/PNG" 
                                                           id="res_image" 
                                                           <?= !(isset($iPictureID) && $iPictureID != '') ? 'multiple=""' : '' ?>
                                                           <?= (isset($iPictureID) && $iPictureID != '') ? '' : 'required=""' ?>/>
                                                    <br />
                                                    <div class="col-lg-6">
                                                        <label class="error" id="file_error"></label>
                                                        <br/>
                                                        <?php if (isset($iPictureID) && $iPictureID != '') { ?>
                                                                <img src="<?= RESTAURANT_PHOTO_IMAGE_PATH_ADMIN. $iRestaurantID . '/thumb/' . $vPictureName; ?>"  style="height:180px;width:256px;">
                                                        <?php } ?>
                                                    </div>
