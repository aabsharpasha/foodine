                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="clearfix">
                                            <h3 class="content-title pull-left">
                                                ...
                                                echo $record_set_restaurant['vRestaurantName'] . "'s  Images";
                                                ?>
                                            </h3>
                                        </div>
                                        <div class="description">Images Listing</div>
                                    </div>
                                </div>
                            </div>
        ...
        <script>
            ...
            $(document).ready(function()
            {
                ...
                var aoculumn = [
                    ...
                    /*2*/ {"mData": "iPictureID", bSortable: false, bSearchable: false, "sWidth": "10%"}
                ];
