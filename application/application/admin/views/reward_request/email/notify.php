                                    ...
                                    <tr style="background:#f5f5f5;border-radius:5px">  
                                        <td style="font-family:verdana;font-size:13px;line-height:1.3em;text-align:left;padding:15px">    
                                            <p style="color:#8d8d8d">
                                                <h2> Dear %REWARD_REQUEST_USER%,</h2>
                                                <br/><br/>%REWARD_MSG%
                                                <br/>
                                                <p><small>Happy to hear from you! If any further queries please email us on <a href="mailto:info@blacklist.com"> info@blacklist.com</a></small></p>
                                            </p>
                                            <p>  Thanks,
                                                <br/>Blacklist Team  
                                            </p>  
