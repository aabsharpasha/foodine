                            ...
                            <div id="divtoappend" class="row">
                                <div class="col-sm-12">
                                    <div class="page-header">
                                        ...
                                        <div class="clearfix">
                                            <h3 class="content-title pull-left">Popular Location <?php echo $this->uppercase; ?></h3>
                                        </div>
                                        <div class="description">Popular Location</div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12 main-rest-list-cms" >
                                    <div class="box border primary">
                                        ...
                                        <div class="box-body big">
                                            <?php
                                            echo form_open("restaurant/savePopularLocationRestaurants", $form_attr);
                                            ?>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9 user-select">
                                                    <select class="form-control maxwidth500" name="restaurants[]" id="selectRestaurants" multiple="multiple">
                                                        <?php foreach($restaurantPick AS $value){ ?>
                                                        <option value="<?php echo $value["Id"]; ?>" <?php if($value["handpick"] > 0) echo "selected" ?>><?php echo $value["vRestaurantName"]?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="margin0auto disptable">
                                                    ...
                                                    &nbsp;<a class="btn-sm btn-grey" href="<?= BASEURL . $this->controller; ?>/popularLocationRest">Cancel</a>
                                                </div>
                                            </div>
                                            <?php echo form_close(); ?>
                                        
<!--                                         <div class="threerow">
                                        <?php foreach ($restaurantPick as $key => $value) { ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6 alignLeft">
                                                        <input type="checkbox" 
                                                               ...
                                                               value="1" 
                                                               data-id="<?= $value['Id'] ?>"
                                                               <?= ($value['handpick'] > 0 ) ? 'checked="checked"' : ''; ?>/>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <script>
            ...
            $(document).ready(function () {
               ...
               //  $(".box-title .box-body.col-sm-4:nth-child(4n)").css('clear','both');
...
//                    selectAllValue: 'all'
            ...
            $('[id^="rest-"]').click(function () {
                ...
                $.ajax({
                    ...
                    url: BASEURL + controller + '/savePick/',
                    success: function () {
                    }
                });
            });
