    ...
    <body>
                            ...
                            <div id="divtoappend" class="row">
                                <div class="col-sm-12">
                                    <div class="page-header">
                                        ...
                                        <div class="description">Restaurants Check-In Listing</div>
                                    </div>
                                </div>
                            </div>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                var target = [];
                var aoculumn = [
                    /*0*/ {"mData": "vFullName", "sWidth": "30%"},
                    /*1*/ {"mData": "tCheckInDateTime", "sWidth": "35%"}
                ];
                var delete_val = btn_show_hide == 1 ? controller + '/deleteAll' : '';
                getdatatable(delete_val, controller + '/paginate_checkin/' + '<?= $iRestaurantID; ?>', aoculumn, target);
            });
        </script>
