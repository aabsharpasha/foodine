                            ...
                            <div id="divtoappend" class="row">
                                <div class="col-sm-12">
                                    <div class="page-header">
                                        ...
                                        <div class="clearfix">
                                            <h3 class="content-title pull-left"><?php echo $this->uppercase; ?> Review</h3>
                                        </div>
                                        <div class="description">Restaurants Review Listing</div>
                                    </div>
                                </div>
                            </div>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                var aoculumn = [
                    ...
                    /*1*/ {"mData": "tReviewDetail", "sWidth": "20%"},
                    /*2*/ {"mData": "tCreatedAt", "sWidth": "35%"}
                ];
                var delete_val = '';
                getdatatable(delete_val, controller + '/paginate_review/' + '<?= $iRestaurantID; ?>', aoculumn, target);
            });
        </script>
