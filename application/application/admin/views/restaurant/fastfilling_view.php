                            ...
                            <div id="divtoappend" class="row">
                                <div class="col-sm-12">
                                    <div class="page-header">
                                        ...
                                        <div class="clearfix">
                                            <h3 class="content-title pull-left">Fast-Filling <?php echo $this->uppercase; ?></h3>
                                        </div>
                                        <div class="description">Fast Filling Restaurant</div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12 main-rest-list-cms" >
                                    <div class="box border primary">
                                        ...
                                        <div class="box-body big">
                                            <?php
                                            echo form_open("restaurant/saveFastfillingRestaurants", $form_attr);
                                            ?>
                                            ...
                                            <div class="form-group">
                                                <div class="margin0auto disptable">
                                                    ...
                                                    &nbsp;<a class="btn-sm btn-grey" href="<?= BASEURL . $this->controller; ?>/fastfillingRest">Cancel</a>
                                                </div>
                                            </div>
                                            <?php echo form_close(); ?>
