                    ...
                    <tr>   
                        <td style="font-family:verdana;font-size:16px;line-height:1.3em;text-align:left;padding:1px 15px;background:none repeat scroll 0px 0px rgb(230,230,230);color:#dd8006" align="left">  
                            <p style="margin-bottom:0px">  
                                <img id="4140330000000131001_imgsrc_url_0_t" style="max-height:75px;margin:5px" src="%LOGO_IMAGE%">  
                            </p>  
                        </td>   
                    </tr>  
                                    ...
                                    <tr style="background:#f5f5f5;border-radius:5px">  
                                        <td stytle="font-family:verdana;font-size:13px;line-height:1.3em;text-align:left;padding:15px">    
                                            <p style="color:#8d8d8d">
                                                ...
                                                <br/><br/>I want also to thank you for your warm welcome of our team at your office. 
