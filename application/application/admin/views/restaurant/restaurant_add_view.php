...
$picT = (isset($vTableLayout) && $vTableLayout != '') ? $vTableLayout : '';
                                    ...
                                    <div class="box border primary">
                                        ...
                                        <div class="box-body big">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                <label class="col-sm-3 control-label">Collection Category<span class="required">*</span></label>
                                                <div class="col-sm-9">
                                                    <select name="iCollectionID[]" id="iCollectionID" class="maxwidth500 col-lg-12 required" multiple>
                                                        <?php
                                                        $collection = $this->restaurant_model->getCollectionDataAll();
                                                        $cui_array = array();
                                                        if (isset($getCollectionData)) {
                                                            foreach ($getCollectionData as $key1 => $cat_value) {
                                                                array_push($cui_array, $cat_value['iCollectionID']);
                                                            }
                                                        }
                                                        //print_r($cat_value);
                                                        foreach ($collection as $key => $value) {
                                                            //print_r($getCategoryData);
                                                            if (isset($getCollectionData) && !empty($getCollectionData)) {
                                                                if (in_array($value['iCollectionID'], $cui_array)) {
                                                                    echo '<option value="' . $value['iCollectionID'] . '" selected="selected">' . $value['vCollectionName'] . '</option>';
                                                                } else {
                                                                    echo '<option value="' . $value['iCollectionID'] . '">' . $value['vCollectionName'] . '</option>';
                                                                }
                                                            } else {
                                                                echo '<option value="' . $value['iCollectionID'] . '">' . $value['vCollectionName'] . '</option>';
                                                            }
...
<!--                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Table Layout Image</label>
                                                <div class="col-sm-9">

                                                    <?php
                                                    if ($picT != '' && $uid != '') {
                                                        $pic_str = '<img src="' . IMGURL . '/vTableLayout/' . $uid . '/thumb/' . $picT . '">';
                                                        $sel_text = 'fileinput-new';
                                                        $change_text = 'fileinput-exists';
                                                        $change_div = 'fileinput-exists';
                                                    } else {
                                                    ...
                                                    <div class="fileinput <?php echo $change_div; ?> " data-provides="fileinput">
                                                        ...
                                                        <input type="hidden" name="vRestImgT" value="<?php echo $picT; ?>"/>
                                                        <div>
                                                            <span class="btn btn-default btn-file">
                                                                <span class="<?php echo $sel_text ?> select_picT" data-trigger="fileinput"  >Select image</span>
                                                                <span class="<?php echo $change_text ?> select_picT" data-trigger="fileinput">Change</span>
                                                                <input type="file" 
                                                                       name="vTableLayout" 
                                                                       accept="image/jpg, image/JPG,image/JPEG, image/jpeg, image/png, image/PNG" 
                                                                       id="vTableLayout" />
                                                            </span>
                                                            <a href="#" class="btn btn-default fileinput-exists" data-dismiss="fileinput" id="removebtnT">Remove</a>
                                                        </div>
                                                        <input type="hidden" id="removepicT" name="removepicT" value="0" />
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label" for="vtableList">Table List (Enter comma separated values)<span class="required"></span></label>
                                                <div class="col-sm-9">
                                                    <textarea  name="vTableList" id="vTableList" class="form-control maxwidth500"><?= isset($vTableList) && $vTableList != '' ? $vTableList : ''; ?></textarea>
                                                </div>
                                            </div>
...
//                        iMaxPrice: {required: "Please enter valid maximum price value"}
                ...
                $('#iFacilityID, #iMusicID, #iCuisineID, #iCategoryID, #iCuisineIDM, #iCollectionID').select2();
